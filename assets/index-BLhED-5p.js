...
`).replace(Ad,``)}function Md(e,t){return t=jd(t),jd(e)===t}function $(e,t,n,r,a,o){switch(n){case`children`:typeof r==`string`?t===`body`||t===`textarea`&&r===``||Qt(e,r):(typeof r==`number`||typeof r==`bigint`)&&t!==`body`&&Qt(e,``+r);break;case`className`:It(e,`class`,r);break;case`tabIndex`:It(e,`tabindex`,r);break;case`dir`:case`role`:case`viewBox`:case`width`:case`height`:It(e,n,r);break;case`style`:tn(e,r,o);break;case`data`:if(t!==`object`){It(e,`data`,r);break}case`src`:case`href`:if(r===``&&(t!==`a`||n!==`href`)){e.removeAttribute(n);break}if(r==null||typeof r==`function`||typeof r==`symbol`||typeof r==`boolean`){e.removeAttribute(n);break}r=on(``+r),e.setAttribute(n,r);break;case`action`:case`formAction`:if(typeof r==`function`){e.setAttribute(n,`javascript:throw new Error('A React form was unexpectedly submitted. If you called form.submit() manually, consider using form.requestSubmit() instead. If you\\'re trying to use event.stopPropagation() in a submit event handler, consider also calling event.preventDefault().')`);break}else typeof o==`function`&&(n===`formAction`?(t!==`input`&&$(e,t,`name`,a.name,a,null),$(e,t,`formEncType`,a.formEncType,a,null),$(e,t,`formMethod`,a.formMethod,a,null),$(e,t,`formTarget`,a.formTarget,a,null)):($(e,t,`encType`,a.encType,a,null),$(e,t,`method`,a.method,a,null),$(e,t,`target`,a.target,a,null)));if(r==null||typeof r==`symbol`||typeof r==`boolean`){e.removeAttribute(n);break}r=on(``+r),e.setAttribute(n,r);break;case`onClick`:r!=null&&(e.onclick=sn);break;case`onScroll`:r!=null&&Q(`scroll`,e);break;case`onScrollEnd`:r!=null&&Q(`scrollend`,e);break;case`dangerouslySetInnerHTML`:if(r!=null){if(typeof r!=`object`||!(`__html`in r))throw Error(i(61));if(n=r.__html,n!=null){if(a.children!=null)throw Error(i(60));e.innerHTML=n}}break;case`multiple`:e.multiple=r&&typeof r!=`function`&&typeof r!=`symbol`;break;case`muted`:e.muted=r&&typeof r!=`function`&&typeof r!=`symbol`;break;case`suppressContentEditableWarning`:case`suppressHydrationWarning`:case`defaultValue`:case`defaultChecked`:case`innerHTML`:case`ref`:break;case`autoFocus`:break;case`xlinkHref`:if(r==null||typeof r==`function`||typeof r==`boolean`||typeof r==`symbol`){e.removeAttribute(`xlink:href`);break}n=on(``+r),e.setAttributeNS(`http://www.w3.org/1999/xlink`,`xlink:href`,n);break;case`contentEditable`:case`spellCheck`:case`draggable`:case`value`:case`autoReverse`:case`externalResourcesRequired`:case`focusable`:case`preserveAlpha`:r!=null&&typeof r!=`function`&&typeof r!=`symbol`?e.setAttribute(n,``+r):e.removeAttribute(n);break;case`inert`:case`allowFullScreen`:case`async`:case`autoPlay`:case`controls`:case`default`:case`defer`:case`disabled`:case`disablePictureInPicture`:case`disableRemotePlayback`:case`formNoValidate`:case`hidden`:case`loop`:case`noModule`:case`noValidate`:case`open`:case`playsInline`:case`readOnly`:case`required`:case`reversed`:case`scoped`:case`seamless`:case`itemScope`:r&&typeof r!=`function`&&typeof r!=`symbol`?e.setAttribute(n,``):e.removeAttribute(n);break;case`capture`:case`download`:!0===r?e.setAttribute(n,``):!1!==r&&r!=null&&typeof r!=`function`&&typeof r!=`symbol`?e.setAttribute(n,r):e.removeAttribute(n);break;case`cols`:case`rows`:case`size`:case`span`:r!=null&&typeof r!=`function`&&typeof r!=`symbol`&&!isNaN(r)&&1<=r?e.setAttribute(n,r):e.removeAttribute(n);break;case`rowSpan`:case`start`:r==null||typeof r==`function`||typeof r==`symbol`||isNaN(r)?e.removeAttribute(n):e.setAttribute(n,r);break;case`popover`:Q(`beforetoggle`,e),Q(`toggle`,e),Ft(e,`popover`,r);break;case`xlinkActuate`:Lt(e,`http://www.w3.org/1999/xlink`,`xlink:actuate`,r);break;case`xlinkArcrole`:Lt(e,`http://www.w3.org/1999/xlink`,`xlink:arcrole`,r);break;case`xlinkRole`:Lt(e,`http://www.w3.org/1999/xlink`,`xlink:role`,r);break;case`xlinkShow`:Lt(e,`http://www.w3.org/1999/xlink`,`xlink:show`,r);break;case`xlinkTitle`:Lt(e,`http://www.w3.org/1999/xlink`,`xlink:title`,r);break;case`xlinkType`:Lt(e,`http://www.w3.org/1999/xlink`,`xlink:type`,r);break;case`xmlBase`:Lt(e,`http://www.w3.org/XML/1998/namespace`,`xml:base`,r);break;case`xmlLang`:Lt(e,`http://www.w3.org/XML/1998/namespace`,`xml:lang`,r);break;case`xmlSpace`:Lt(e,`http://www.w3.org/XML/1998/namespace`,`xml:space`,r);break;case`is`:Ft(e,`is`,r);break;case`innerText`:case`textContent`:break;default:(!(2<n.length)||n[0]!==`o`&&n[0]!==`O`||n[1]!==`n`&&n[1]!==`N`)&&(n=rn.get(n)||n,Ft(e,n,r))}}function Nd(e,t,n,r,a,o){switch(n){case`style`:tn(e,r,o);break;case`dangerouslySetInnerHTML`:if(r!=null){if(typeof r!=`object`||!(`__html`in r))throw Error(i(61));if(n=r.__html,n!=null){if(a.children!=null)throw Error(i(60));e.innerHTML=n}}break;case`children`:typeof r==`string`?Qt(e,r):(typeof r==`number`||typeof r==`bigint`)&&Qt(e,``+r);break;case`onScroll`:r!=null&&Q(`scroll`,e);break;case`onScrollEnd`:r!=null&&Q(`scrollend`,e);break;case`onClick`:r!=null&&(e.onclick=sn);break;case`suppressContentEditableWarning`:case`suppressHydrationWarning`:case`innerHTML`:case`ref`:break;case`innerText`:case`textContent`:break;default:if(!Ot.hasOwnProperty(n))a:{if(n[0]===`o`&&n[1]===`n`&&(a=n.endsWith(`Capture`),t=n.slice(2,a?n.length-7:void 0),o=e[ht]||null,o=o==null?null:o[n],typeof o==`function`&&e.removeEventListener(t,o,a),typeof r==`function`)){typeof o!=`function`&&o!==null&&(n in e?e[n]=null:e.hasAttribute(n)&&e.removeAttribute(n)),e.addEventListener(t,r,a);break a}n in e?e[n]=r:!0===r?e.setAttribute(n,``):Ft(e,n,r)}}}function Pd(e,t,n){switch(t){case`div`:case`span`:case`svg`:case`path`:case`a`:case`g`:case`p`:case`li`:break;case`img`:Q(`error`,e),Q(`load`,e);var r=!1,a=!1,o;for(o in n)if(n.hasOwnProperty(o)){var s=n[o];if(s!=null)switch(o){case`src`:r=!0;break;case`srcSet`:a=!0;break;case`children`:case`dangerouslySetInnerHTML`:throw Error(i(137,t));default:$(e,t,o,s,n,null)}}a&&$(e,t,`srcSet`,n.srcSet,n,null),r&&$(e,t,`src`,n.src,n,null);return;case`input`:Q(`invalid`,e);var c=o=s=a=null,l=null,u=null;for(r in n)if(n.hasOwnProperty(r)){var d=n[r];if(d!=null)switch(r){case`name`:a=d;break;case`type`:s=d;break;case`checked`:l=d;break;case`defaultChecked`:u=d;break;case`value`:o=d;break;case`defaultValue`:c=d;break;case`children`:case`dangerouslySetInnerHTML`:if(d!=null)throw Error(i(137,t));break;default:$(e,t,r,d,n,null)}}qt(e,o,c,l,u,s,a,!1);return;case`select`:for(a in Q(`invalid`,e),r=s=o=null,n)if(n.hasOwnProperty(a)&&(c=n[a],c!=null))switch(a){case`value`:o=c;break;case`defaultValue`:s=c;break;case`multiple`:r=c;default:$(e,t,a,c,n,null)}t=o,n=s,e.multiple=!!r,t==null?n!=null&&Yt(e,!!r,n,!0):Yt(e,!!r,t,!1);return;case`textarea`:for(s in Q(`invalid`,e),o=a=r=null,n)if(n.hasOwnProperty(s)&&(c=n[s],c!=null))switch(s){case`value`:r=c;break;case`defaultValue`:a=c;break;case`children`:o=c;break;case`dangerouslySetInnerHTML`:if(c!=null)throw Error(i(91));break;default:$(e,t,s,c,n,null)}Zt(e,r,a,o);return;case`option`:for(l in n)if(n.hasOwnProperty(l)&&(r=n[l],r!=null))switch(l){case`selected`:e.selected=r&&typeof r!=`function`&&typeof r!=`symbol`;break;default:$(e,t,l,r,n,null)}return;case`dialog`:Q(`beforetoggle`,e),Q(`toggle`,e),Q(`cancel`,e),Q(`close`,e);break;case`iframe`:case`object`:Q(`load`,e);break;case`video`:case`audio`:for(r=0;r<_d.length;r++)Q(_d[r],e);break;case`image`:Q(`error`,e),Q(`load`,e);break;case`details`:Q(`toggle`,e);break;case`embed`:case`source`:case`link`:Q(`error`,e),Q(`load`,e);case`area`:case`base`:case`br`:case`col`:case`hr`:case`keygen`:case`meta`:case`param`:case`track`:case`wbr`:case`menuitem`:for(u in n)if(n.hasOwnProperty(u)&&(r=n[u],r!=null))switch(u){case`children`:case`dangerouslySetInnerHTML`:throw Error(i(137,t));default:$(e,t,u,r,n,null)}return;default:if(nn(t)){for(d in n)n.hasOwnProperty(d)&&(r=n[d],r!==void 0&&Nd(e,t,d,r,n,void 0));return}}for(c in n)n.hasOwnProperty(c)&&(r=n[c],r!=null&&$(e,t,c,r,n,null))}function Fd(e,t,n,r){switch(t){case`div`:case`span`:case`svg`:case`path`:case`a`:case`g`:case`p`:case`li`:break;case`input`:var a=null,o=null,s=null,c=null,l=null,u=null,d=null;for(m in n){var f=n[m];if(n.hasOwnProperty(m)&&f!=null)switch(m){case`checked`:break;case`value`:break;case`defaultValue`:l=f;default:r.hasOwnProperty(m)||$(e,t,m,null,r,f)}}for(var p in r){var m=r[p];if(f=n[p],r.hasOwnProperty(p)&&(m!=null||f!=null))switch(p){case`type`:o=m;break;case`name`:a=m;break;case`checked`:u=m;break;case`defaultChecked`:d=m;break;case`value`:s=m;break;case`defaultValue`:c=m;break;case`children`:case`dangerouslySetInnerHTML`:if(m!=null)throw Error(i(137,t));break;default:m!==f&&$(e,t,p,m,r,f)}}Kt(e,s,c,l,u,d,o,a);return;case`select`:for(o in m=s=c=p=null,n)if(l=n[o],n.hasOwnProperty(o)&&l!=null)switch(o){case`value`:break;case`multiple`:m=l;default:r.hasOwnProperty(o)||$(e,t,o,null,r,l)}for(a in r)if(o=r[a],l=n[a],r.hasOwnProperty(a)&&(o!=null||l!=null))switch(a){case`value`:p=o;break;case`defaultValue`:c=o;break;case`multiple`:s=o;default:o!==l&&$(e,t,a,o,r,l)}t=c,n=s,r=m,p==null?!!r!=!!n&&(t==null?Yt(e,!!n,n?[]:``,!1):Yt(e,!!n,t,!0)):Yt(e,!!n,p,!1);return;case`textarea`:for(c in m=p=null,n)if(a=n[c],n.hasOwnProperty(c)&&a!=null&&!r.hasOwnProperty(c))switch(c){case`value`:break;case`children`:break;default:$(e,t,c,null,r,a)}for(s in r)if(a=r[s],o=n[s],r.hasOwnProperty(s)&&(a!=null||o!=null))switch(s){case`value`:p=a;break;case`defaultValue`:m=a;break;case`children`:break;case`dangerouslySetInnerHTML`:if(a!=null)throw Error(i(91));break;default:a!==o&&$(e,t,s,a,r,o)}Xt(e,p,m);return;case`option`:for(var h in n)if(p=n[h],n.hasOwnProperty(h)&&p!=null&&!r.hasOwnProperty(h))switch(h){case`selected`:e.selected=!1;break;default:$(e,t,h,null,r,p)}for(l in r)if(p=r[l],m=n[l],r.hasOwnProperty(l)&&p!==m&&(p!=null||m!=null))switch(l){case`selected`:e.selected=p&&typeof p!=`function`&&typeof p!=`symbol`;break;default:$(e,t,l,p,r,m)}return;case`img`:case`link`:case`area`:case`base`:case`br`:case`col`:case`embed`:case`hr`:case`keygen`:case`meta`:case`param`:case`source`:case`track`:case`wbr`:case`menuitem`:for(var g in n)p=n[g],n.hasOwnProperty(g)&&p!=null&&!r.hasOwnProperty(g)&&$(e,t,g,null,r,p);for(u in r)if(p=r[u],m=n[u],r.hasOwnProperty(u)&&p!==m&&(p!=null||m!=null))switch(u){case`children`:case`dangerouslySetInnerHTML`:if(p!=null)throw Error(i(137,t));break;default:$(e,t,u,p,r,m)}return;default:if(nn(t)){for(var _ in n)p=n[_],n.hasOwnProperty(_)&&p!==void 0&&!r.hasOwnProperty(_)&&Nd(e,t,_,void 0,r,p);for(d in r)p=r[d],m=n[d],!r.hasOwnProperty(d)||p===m||p===void 0&&m===void 0||Nd(e,t,d,p,r,m);return}}for(var v in n)p=n[v],n.hasOwnProperty(v)&&p!=null&&!r.hasOwnProperty(v)&&$(e,t,v,null,r,p);for(f in r)p=r[f],m=n[f],!r.hasOwnProperty(f)||p===m||p==null&&m==null||$(e,t,f,p,r,m)}function Id(e){switch(e){case`css`:case`script`:case`font`:case`img`:case`image`:case`input`:case`link`:return!0;default:return!1}}function Ld(){if(typeof performance.getEntriesByType==`function`){for(var e=0,t=0,n=performance.getEntriesByType(`resource`),r=0;r<n.length;r++){var i=n[r],a=i.transferSize,o=i.initiatorType,s=i.duration;if(a&&s&&Id(o)){for(o=0,s=i.responseEnd,r+=1;r<n.length;r++){var c=n[r],l=c.startTime;if(l>s)break;var u=c.transferSize,d=c.initiatorType;u&&Id(d)&&(c=c.responseEnd,o+=u*(c<s?1:(s-l)/(c-l)))}if(--r,t+=8*(a+o)/(i.duration/1e3),e++,10<e)break}}if(0<e)return t/e/1e6}return navigator.connection&&(e=navigator.connection.downlink,typeof e==`number`)?e:5}var Rd=null,zd=null;function Bd(e){return e.nodeType===9?e:e.ownerDocument}function Vd(e){switch(e){case`http://www.w3.org/2000/svg`:return 1;case`http://www.w3.org/1998/Math/MathML`:return 2;default:return 0}}function Hd(e,t){if(e===0)switch(t){case`svg`:return 1;case`math`:return 2;default:return 0}return e===1&&t===`foreignObject`?0:e}function Ud(e,t){return e===`textarea`||e===`noscript`||typeof t.children==`string`||typeof t.children==`number`||typeof t.children==`bigint`||typeof t.dangerouslySetInnerHTML==`object`&&t.dangerouslySetInnerHTML!==null&&t.dangerouslySetInnerHTML.__html!=null}var Wd=null;function Gd(){var e=window.event;return e&&e.type===`popstate`?e===Wd?!1:(Wd=e,!0):(Wd=null,!1)}var Kd=typeof setTimeout==`function`?setTimeout:void 0,qd=typeof clearTimeout==`function`?clearTimeout:void 0,Jd=typeof Promise==`function`?Promise:void 0,Yd=typeof queueMicrotask==`function`?queueMicrotask:Jd===void 0?Kd:function(e){return Jd.resolve(null).then(e).catch(Xd)};function Xd(e){setTimeout(function(){throw e})}function Zd(e){return e===`head`}function Qd(e,t){var n=t,r=0;do{var i=n.nextSibling;if(e.removeChild(n),i&&i.nodeType===8)if(n=i.data,n===`/$`||n===`/&`){if(r===0){e.removeChild(i),Np(t);return}r--}else if(n===`$`||n===`$?`||n===`$~`||n===`$!`||n===`&`)r++;else if(n===`html`)pf(e.ownerDocument.documentElement);else if(n===`head`){n=e.ownerDocument.head,pf(n);for(var a=n.firstChild;a;){var o=a.nextSibling,s=a.nodeName;a[xt]||s===`SCRIPT`||s===`STYLE`||s===`LINK`&&a.rel.toLowerCase()===`stylesheet`||n.removeChild(a),a=o}}else n===`body`&&pf(e.ownerDocument.body);n=i}while(n);Np(t)}function $d(e,t){var n=e;e=0;do{var r=n.nextSibling;if(n.nodeType===1?t?(n._stashedDisplay=n.style.display,n.style.display=`none`):(n.style.display=n._stashedDisplay||``,n.getAttribute(`style`)===``&&n.removeAttribute(`style`)):n.nodeType===3&&(t?(n._stashedText=n.nodeValue,n.nodeValue=``):n.nodeValue=n._stashedText||``),r&&r.nodeType===8)if(n=r.data,n===`/$`){if(e===0)break;e--}else n!==`$`&&n!==`$?`&&n!==`$~`&&n!==`$!`||e++;n=r}while(n)}function ef(e){var t=e.firstChild;for(t&&t.nodeType===10&&(t=t.nextSibling);t;){var n=t;switch(t=t.nextSibling,n.nodeName){case`HTML`:case`HEAD`:case`BODY`:ef(n),St(n);continue;case`SCRIPT`:case`STYLE`:continue;case`LINK`:if(n.rel.toLowerCase()===`stylesheet`)continue}e.removeChild(n)}}function tf(e,t,n,r){for(;e.nodeType===1;){var i=n;if(e.nodeName.toLowerCase()!==t.toLowerCase()){if(!r&&(e.nodeName!==`INPUT`||e.type!==`hidden`))break}else if(!r)if(t===`input`&&e.type===`hidden`){var a=i.name==null?null:``+i.name;if(i.type===`hidden`&&e.getAttribute(`name`)===a)return e}else return e;else if(!e[xt])switch(t){case`meta`:if(!e.hasAttribute(`itemprop`))break;return e;case`link`:if(a=e.getAttribute(`rel`),a===`stylesheet`&&e.hasAttribute(`data-precedence`)||a!==i.rel||e.getAttribute(`href`)!==(i.href==null||i.href===``?null:i.href)||e.getAttribute(`crossorigin`)!==(i.crossOrigin==null?null:i.crossOrigin)||e.getAttribute(`title`)!==(i.title==null?null:i.title))break;return e;case`style`:if(e.hasAttribute(`data-precedence`))break;return e;case`script`:if(a=e.getAttribute(`src`),(a!==(i.src==null?null:i.src)||e.getAttribute(`type`)!==(i.type==null?null:i.type)||e.getAttribute(`crossorigin`)!==(i.crossOrigin==null?null:i.crossOrigin))&&a&&e.hasAttribute(`async`)&&!e.hasAttribute(`itemprop`))break;return e;default:return e}if(e=cf(e.nextSibling),e===null)break}return null}function nf(e,t,n){if(t===``)return null;for(;e.nodeType!==3;)if((e.nodeType!==1||e.nodeName!==`INPUT`||e.type!==`hidden`)&&!n||(e=cf(e.nextSibling),e===null))return null;return e}function rf(e,t){for(;e.nodeType!==8;)if((e.nodeType!==1||e.nodeName!==`INPUT`||e.type!==`hidden`)&&!t||(e=cf(e.nextSibling),e===null))return null;return e}function af(e){return e.data===`$?`||e.data===`$~`}function of(e){return e.data===`$!`||e.data===`$?`&&e.ownerDocument.readyState!==`loading`}function sf(e,t){var n=e.ownerDocument;if(e.data===`$~`)e._reactRetry=t;else if(e.data!==`$?`||n.readyState!==`loading`)t();else{var r=function(){t(),n.removeEventListener(`DOMContentLoaded`,r)};n.addEventListener(`DOMContentLoaded`,r),e._reactRetry=r}}function cf(e){for(;e!=null;e=e.nextSibling){var t=e.nodeType;if(t===1||t===3)break;if(t===8){if(t=e.data,t===`$`||t===`$!`||t===`$?`||t===`$~`||t===`&`||t===`F!`||t===`F`)break;if(t===`/$`||t===`/&`)return null}}return e}var lf=null;function uf(e){e=e.nextSibling;for(var t=0;e;){if(e.nodeType===8){var n=e.data;if(n===`/$`||n===`/&`){if(t===0)return cf(e.nextSibling);t--}else n!==`$`&&n!==`$!`&&n!==`$?`&&n!==`$~`&&n!==`&`||t++}e=e.nextSibling}return null}function df(e){e=e.previousSibling;for(var t=0;e;){if(e.nodeType===8){var n=e.data;if(n===`$`||n===`$!`||n===`$?`||n===`$~`||n===`&`){if(t===0)return e;t--}else n!==`/$`&&n!==`/&`||t++}e=e.previousSibling}return null}function ff(e,t,n){switch(t=Bd(n),e){case`html`:if(e=t.documentElement,!e)throw Error(i(452));return e;case`head`:if(e=t.head,!e)throw Error(i(453));return e;case`body`:if(e=t.body,!e)throw Error(i(454));return e;default:throw Error(i(451))}}function pf(e){for(var t=e.attributes;t.length;)e.removeAttributeNode(t[0]);St(e)}var mf=new Map,hf=new Set;function gf(e){return typeof e.getRootNode==`function`?e.getRootNode():e.nodeType===9?e:e.ownerDocument}var _f=E.d;E.d={f:vf,r:yf,D:Sf,C:Cf,L:wf,m:Tf,X:Df,S:Ef,M:Of};function vf(){var e=_f.f(),t=bu();return e||t}function yf(e){var t=wt(e);t!==null&&t.tag===5&&t.type===`form`?ks(t):_f.r(e)}var bf=typeof document>`u`?null:document;function xf(e,t,n){var r=bf;if(r&&typeof t==`string`&&t){var i=Gt(t);i=`link[rel="`+e+`"][href="`+i+`"]`,typeof n==`string`&&(i+=`[crossorigin="`+n+`"]`),hf.has(i)||(hf.add(i),e={rel:e,crossOrigin:n,href:t},r.querySelector(i)===null&&(t=r.createElement(`link`),Pd(t,`link`,e),j(t),r.head.appendChild(t)))}}function Sf(e){_f.D(e),xf(`dns-prefetch`,e,null)}function Cf(e,t){_f.C(e,t),xf(`preconnect`,e,t)}function wf(e,t,n){_f.L(e,t,n);var r=bf;if(r&&e&&t){var i=`link[rel="preload"][as="`+Gt(t)+`"]`;t===`image`&&n&&n.imageSrcSet?(i+=`[imagesrcset="`+Gt(n.imageSrcSet)+`"]`,typeof n.imageSizes==`string`&&(i+=`[imagesizes="`+Gt(n.imageSizes)+`"]`)):i+=`[href="`+Gt(e)+`"]`;var a=i;switch(t){case`style`:a=Af(e);break;case`script`:a=Pf(e)}mf.has(a)||(e=h({rel:`preload`,href:t===`image`&&n&&n.imageSrcSet?void 0:e,as:t},n),mf.set(a,e),r.querySelector(i)!==null||t===`style`&&r.querySelector(jf(a))||t===`script`&&r.querySelector(Ff(a))||(t=r.createElement(`link`),Pd(t,`link`,e),j(t),r.head.appendChild(t)))}}function Tf(e,t){_f.m(e,t);var n=bf;if(n&&e){var r=t&&typeof t.as==`string`?t.as:`script`,i=`link[rel="modulepreload"][as="`+Gt(r)+`"][href="`+Gt(e)+`"]`,a=i;switch(r){case`audioworklet`:case`paintworklet`:case`serviceworker`:case`sharedworker`:case`worker`:case`script`:a=Pf(e)}if(!mf.has(a)&&(e=h({rel:`modulepreload`,href:e},t),mf.set(a,e),n.querySelector(i)===null)){switch(r){case`audioworklet`:case`paintworklet`:case`serviceworker`:case`sharedworker`:case`worker`:case`script`:if(n.querySelector(Ff(a)))return}r=n.createElement(`link`),Pd(r,`link`,e),j(r),n.head.appendChild(r)}}}function Ef(e,t,n){_f.S(e,t,n);var r=bf;if(r&&e){var i=Et(r).hoistableStyles,a=Af(e);t||=`default`;var o=i.get(a);if(!o){var s={loading:0,preload:null};if(o=r.querySelector(jf(a)))s.loading=5;else{e=h({rel:`stylesheet`,href:e,"data-precedence":t},n),(n=mf.get(a))&&Rf(e,n);var c=o=r.createElement(`link`);j(c),Pd(c,`link`,e),c._p=new Promise(function(e,t){c.onload=e,c.onerror=t}),c.addEventListener(`load`,function(){s.loading|=1}),c.addEventListener(`error`,function(){s.loading|=2}),s.loading|=4,Lf(o,t,r)}o={type:`stylesheet`,instance:o,count:1,state:s},i.set(a,o)}}}function Df(e,t){_f.X(e,t);var n=bf;if(n&&e){var r=Et(n).hoistableScripts,i=Pf(e),a=r.get(i);a||(a=n.querySelector(Ff(i)),a||(e=h({src:e,async:!0},t),(t=mf.get(i))&&zf(e,t),a=n.createElement(`script`),j(a),Pd(a,`link`,e),n.head.appendChild(a)),a={type:`script`,instance:a,count:1,state:null},r.set(i,a))}}function Of(e,t){_f.M(e,t);var n=bf;if(n&&e){var r=Et(n).hoistableScripts,i=Pf(e),a=r.get(i);a||(a=n.querySelector(Ff(i)),a||(e=h({src:e,async:!0,type:`module`},t),(t=mf.get(i))&&zf(e,t),a=n.createElement(`script`),j(a),Pd(a,`link`,e),n.head.appendChild(a)),a={type:`script`,instance:a,count:1,state:null},r.set(i,a))}}function kf(e,t,n,r){var a=(a=ve.current)?gf(a):null;if(!a)throw Error(i(446));switch(e){case`meta`:case`title`:return null;case`style`:return typeof n.precedence==`string`&&typeof n.href==`string`?(t=Af(n.href),n=Et(a).hoistableStyles,r=n.get(t),r||(r={type:`style`,instance:null,count:0,state:null},n.set(t,r)),r):{type:`void`,instance:null,count:0,state:null};case`link`:if(n.rel===`stylesheet`&&typeof n.href==`string`&&typeof n.precedence==`string`){e=Af(n.href);var o=Et(a).hoistableStyles,s=o.get(e);if(s||(a=a.ownerDocument||a,s={type:`stylesheet`,instance:null,count:0,state:{loading:0,preload:null}},o.set(e,s),(o=a.querySelector(jf(e)))&&!o._p&&(s.instance=o,s.state.loading=5),mf.has(e)||(n={rel:`preload`,as:`style`,href:n.href,crossOrigin:n.crossOrigin,integrity:n.integrity,media:n.media,hrefLang:n.hrefLang,referrerPolicy:n.referrerPolicy},mf.set(e,n),o||Nf(a,e,n,s.state))),t&&r===null)throw Error(i(528,``));return s}if(t&&r!==null)throw Error(i(529,``));return null;case`script`:return t=n.async,n=n.src,typeof n==`string`&&t&&typeof t!=`function`&&typeof t!=`symbol`?(t=Pf(n),n=Et(a).hoistableScripts,r=n.get(t),r||(r={type:`script`,instance:null,count:0,state:null},n.set(t,r)),r):{type:`void`,instance:null,count:0,state:null};default:throw Error(i(444,e))}}function Af(e){return`href="`+Gt(e)+`"`}function jf(e){return`link[rel="stylesheet"][`+e+`]`}function Mf(e){return h({},e,{"data-precedence":e.precedence,precedence:null})}function Nf(e,t,n,r){e.querySelector(`link[rel="preload"][as="style"][`+t+`]`)?r.loading=1:(t=e.createElement(`link`),r.preload=t,t.addEventListener(`load`,function(){return r.loading|=1}),t.addEventListener(`error`,function(){return r.loading|=2}),Pd(t,`link`,n),j(t),e.head.appendChild(t))}function Pf(e){return`[src="`+Gt(e)+`"]`}function Ff(e){return`script[async]`+e}function If(e,t,n){if(t.count++,t.instance===null)switch(t.type){case`style`:var r=e.querySelector(`style[data-href~="`+Gt(n.href)+`"]`);if(r)return t.instance=r,j(r),r;var a=h({},n,{"data-href":n.href,"data-precedence":n.precedence,href:null,precedence:null});return r=(e.ownerDocument||e).createElement(`style`),j(r),Pd(r,`style`,a),Lf(r,n.precedence,e),t.instance=r;case`stylesheet`:a=Af(n.href);var o=e.querySelector(jf(a));if(o)return t.state.loading|=4,t.instance=o,j(o),o;r=Mf(n),(a=mf.get(a))&&Rf(r,a),o=(e.ownerDocument||e).createElement(`link`),j(o);var s=o;return s._p=new Promise(function(e,t){s.onload=e,s.onerror=t}),Pd(o,`link`,r),t.state.loading|=4,Lf(o,n.precedence,e),t.instance=o;case`script`:return o=Pf(n.src),(a=e.querySelector(Ff(o)))?(t.instance=a,j(a),a):(r=n,(a=mf.get(o))&&(r=h({},n),zf(r,a)),e=e.ownerDocument||e,a=e.createElement(`script`),j(a),Pd(a,`link`,r),e.head.appendChild(a),t.instance=a);case`void`:return null;default:throw Error(i(443,t.type))}else t.type===`stylesheet`&&!(t.state.loading&4)&&(r=t.instance,t.state.loading|=4,Lf(r,n.precedence,e));return t.instance}function Lf(e,t,n){for(var r=n.querySelectorAll(`link[rel="stylesheet"][data-precedence],style[data-precedence]`),i=r.length?r[r.length-1]:null,a=i,o=0;o<r.length;o++){var s=r[o];if(s.dataset.precedence===t)a=s;else if(a!==i)break}a?a.parentNode.insertBefore(e,a.nextSibling):(t=n.nodeType===9?n.head:n,t.insertBefore(e,t.firstChild))}function Rf(e,t){e.crossOrigin??=t.crossOrigin,e.referrerPolicy??=t.referrerPolicy,e.title??=t.title}function zf(e,t){e.crossOrigin??=t.crossOrigin,e.referrerPolicy??=t.referrerPolicy,e.integrity??=t.integrity}var Bf=null;function Vf(e,t,n){if(Bf===null){var r=new Map,i=Bf=new Map;i.set(n,r)}else i=Bf,r=i.get(n),r||(r=new Map,i.set(n,r));if(r.has(e))return r;for(r.set(e,null),n=n.getElementsByTagName(e),i=0;i<n.length;i++){var a=n[i];if(!(a[xt]||a[A]||e===`link`&&a.getAttribute(`rel`)===`stylesheet`)&&a.namespaceURI!==`http://www.w3.org/2000/svg`){var o=a.getAttribute(t)||``;o=e+o;var s=r.get(o);s?s.push(a):r.set(o,[a])}}return r}function Hf(e,t,n){e=e.ownerDocument||e,e.head.insertBefore(n,t===`title`?e.querySelector(`head > title`):null)}function Uf(e,t,n){if(n===1||t.itemProp!=null)return!1;switch(e){case`meta`:case`title`:return!0;case`style`:if(typeof t.precedence!=`string`||typeof t.href!=`string`||t.href===``)break;return!0;case`link`:if(typeof t.rel!=`string`||typeof t.href!=`string`||t.href===``||t.onLoad||t.onError)break;switch(t.rel){case`stylesheet`:return e=t.disabled,typeof t.precedence==`string`&&e==null;default:return!0}case`script`:if(t.async&&typeof t.async!=`function`&&typeof t.async!=`symbol`&&!t.onLoad&&!t.onError&&t.src&&typeof t.src==`string`)return!0}return!1}function Wf(e){return!(e.type===`stylesheet`&&!(e.state.loading&3))}function Gf(e,t,n,r){if(n.type===`stylesheet`&&(typeof r.media!=`string`||!1!==matchMedia(r.media).matches)&&!(n.state.loading&4)){if(n.instance===null){var i=Af(r.href),a=t.querySelector(jf(i));if(a){t=a._p,typeof t==`object`&&t&&typeof t.then==`function`&&(e.count++,e=Jf.bind(e),t.then(e,e)),n.state.loading|=4,n.instance=a,j(a);return}a=t.ownerDocument||t,r=Mf(r),(i=mf.get(i))&&Rf(r,i),a=a.createElement(`link`),j(a);var o=a;o._p=new Promise(function(e,t){o.onload=e,o.onerror=t}),Pd(a,`link`,r),n.instance=a}e.stylesheets===null&&(e.stylesheets=new Map),e.stylesheets.set(n,t),(t=n.state.preload)&&!(n.state.loading&3)&&(e.count++,n=Jf.bind(e),t.addEventListener(`load`,n),t.addEventListener(`error`,n))}}var Kf=0;function qf(e,t){return e.stylesheets&&e.count===0&&Xf(e,e.stylesheets),0<e.count||0<e.imgCount?function(n){var r=setTimeout(function(){if(e.stylesheets&&Xf(e,e.stylesheets),e.unsuspend){var t=e.unsuspend;e.unsuspend=null,t()}},6e4+t);0<e.imgBytes&&Kf===0&&(Kf=62500*Ld());var i=setTimeout(function(){if(e.waitingForImages=!1,e.count===0&&(e.stylesheets&&Xf(e,e.stylesheets),e.unsuspend)){var t=e.unsuspend;e.unsuspend=null,t()}},(e.imgBytes>Kf?50:800)+t);return e.unsuspend=n,function(){e.unsuspend=null,clearTimeout(r),clearTimeout(i)}}:null}function Jf(){if(this.count--,this.count===0&&(this.imgCount===0||!this.waitingForImages)){if(this.stylesheets)Xf(this,this.stylesheets);else if(this.unsuspend){var e=this.unsuspend;this.unsuspend=null,e()}}}var Yf=null;function Xf(e,t){e.stylesheets=null,e.unsuspend!==null&&(e.count++,Yf=new Map,t.forEach(Zf,e),Yf=null,Jf.call(e))}function Zf(e,t){if(!(t.state.loading&4)){var n=Yf.get(e);if(n)var r=n.get(null);else{n=new Map,Yf.set(e,n);for(var i=e.querySelectorAll(`link[data-precedence],style[data-precedence]`),a=0;a<i.length;a++){var o=i[a];(o.nodeName===`LINK`||o.getAttribute(`media`)!==`not all`)&&(n.set(o.dataset.precedence,o),r=o)}r&&n.set(null,r)}i=t.instance,o=i.getAttribute(`data-precedence`),a=n.get(o)||r,a===r&&n.set(null,i),n.set(o,i),this.count++,r=Jf.bind(this),i.addEventListener(`load`,r),i.addEventListener(`error`,r),a?a.parentNode.insertBefore(i,a.nextSibling):(e=e.nodeType===9?e.head:e,e.insertBefore(i,e.firstChild)),t.state.loading|=4}}var Qf={$$typeof:S,Provider:null,Consumer:null,_currentValue:de,_currentValue2:de,_threadCount:0};function $f(e,t,n,r,i,a,o,s,c){this.tag=1,this.containerInfo=e,this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.next=this.pendingContext=this.context=this.cancelPendingCommit=null,this.callbackPriority=0,this.expirationTimes=it(-1),this.entangledLanes=this.shellSuspendCounter=this.errorRecoveryDisabledLanes=this.expiredLanes=this.warmLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=it(0),this.hiddenUpdates=it(null),this.identifierPrefix=r,this.onUncaughtError=i,this.onCaughtError=a,this.onRecoverableError=o,this.pooledCache=null,this.pooledCacheLanes=0,this.formState=c,this.incompleteTransitions=new Map}function ep(e,t,n,r,i,a,o,s,c,l,u,d){return e=new $f(e,t,n,o,c,l,u,d,s),t=1,!0===a&&(t|=24),a=hi(3,null,null,t),e.current=a,a.stateNode=e,t=pa(),t.refCount++,e.pooledCache=t,t.refCount++,a.memoizedState={element:r,isDehydrated:n,cache:t},Ka(a),e}function tp(e){return e?(e=pi,e):pi}function np(e,t,n,r,i,a){i=tp(i),r.context===null?r.context=i:r.pendingContext=i,r=Ja(t),r.payload={element:n},a=a===void 0?null:a,a!==null&&(r.callback=a),n=Ya(e,r,t),n!==null&&(hu(n,e,t),Xa(n,e,t))}function rp(e,t){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var n=e.retryLane;e.retryLane=n!==0&&n<t?n:t}}function ip(e,t){rp(e,t),(e=e.alternate)&&rp(e,t)}function ap(e){if(e.tag===13||e.tag===31){var t=ui(e,67108864);t!==null&&hu(t,e,67108864),ip(e,67108864)}}function op(e){if(e.tag===13||e.tag===31){var t=pu();t=ut(t);var n=ui(e,t);n!==null&&hu(n,e,t),ip(e,t)}}var sp=!0;function cp(e,t,n,r){var i=T.T;T.T=null;var a=E.p;try{E.p=2,up(e,t,n,r)}finally{E.p=a,T.T=i}}function lp(e,t,n,r){var i=T.T;T.T=null;var a=E.p;try{E.p=8,up(e,t,n,r)}finally{E.p=a,T.T=i}}function up(e,t,n,r){if(sp){var i=dp(r);if(i===null)wd(e,t,r,fp,n),Cp(e,r);else if(Tp(i,e,t,n,r))r.stopPropagation();else if(Cp(e,r),t&4&&-1<Sp.indexOf(e)){for(;i!==null;){var a=wt(i);if(a!==null)switch(a.tag){case 3:if(a=a.stateNode,a.current.memoizedState.isDehydrated){var o=$e(a.pendingLanes);if(o!==0){var s=a;for(s.pendingLanes|=2,s.entangledLanes|=2;o;){var c=1<<31-qe(o);s.entanglements[1]|=c,o&=~c}rd(a),!(G&6)&&(tu=Ie()+500,id(0,!1))}}break;case 31:case 13:s=ui(a,2),s!==null&&hu(s,a,2),bu(),ip(a,2)}if(a=dp(r),a===null&&wd(e,t,r,fp,n),a===i)break;i=a}i!==null&&r.stopPropagation()}else wd(e,t,r,null,n)}}function dp(e){return e=ln(e),pp(e)}var fp=null;function pp(e){if(fp=null,e=Ct(e),e!==null){var t=o(e);if(t===null)e=null;else{var n=t.tag;if(n===13){if(e=s(t),e!==null)return e;e=null}else if(n===31){if(e=c(t),e!==null)return e;e=null}else if(n===3){if(t.stateNode.current.memoizedState.isDehydrated)return t.tag===3?t.stateNode.containerInfo:null;e=null}else t!==e&&(e=null)}}return fp=e,null}function mp(e){switch(e){case`beforetoggle`:case`cancel`:case`click`:case`close`:case`contextmenu`:case`copy`:case`cut`:case`auxclick`:case`dblclick`:case`dragend`:case`dragstart`:case`drop`:case`focusin`:case`focusout`:case`input`:case`invalid`:case`keydown`:case`keypress`:case`keyup`:case`mousedown`:case`mouseup`:case`paste`:case`pause`:case`play`:case`pointercancel`:case`pointerdown`:case`pointerup`:case`ratechange`:case`reset`:case`resize`:case`seeked`:case`submit`:case`toggle`:case`touchcancel`:case`touchend`:case`touchstart`:case`volumechange`:case`change`:case`selectionchange`:case`textInput`:case`compositionstart`:case`compositionend`:case`compositionupdate`:case`beforeblur`:case`afterblur`:case`beforeinput`:case`blur`:case`fullscreenchange`:case`focus`:case`hashchange`:case`popstate`:case`select`:case`selectstart`:return 2;case`drag`:case`dragenter`:case`dragexit`:case`dragleave`:case`dragover`:case`mousemove`:case`mouseout`:case`mouseover`:case`pointermove`:case`pointerout`:case`pointerover`:case`scroll`:case`touchmove`:case`wheel`:case`mouseenter`:case`mouseleave`:case`pointerenter`:case`pointerleave`:return 8;case`message`:switch(Le()){case Re:return 2;case ze:return 8;case Be:case O:return 32;case Ve:return 268435456;default:return 32}default:return 32}}var hp=!1,gp=null,_p=null,vp=null,yp=new Map,bp=new Map,xp=[],Sp=`mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset`.split(` `);function Cp(e,t){switch(e){case`focusin`:case`focusout`:gp=null;break;case`dragenter`:case`dragleave`:_p=null;break;case`mouseover`:case`mouseout`:vp=null;break;case`pointerover`:case`pointerout`:yp.delete(t.pointerId);break;case`gotpointercapture`:case`lostpointercapture`:bp.delete(t.pointerId)}}function wp(e,t,n,r,i,a){return e===null||e.nativeEvent!==a?(e={blockedOn:t,domEventName:n,eventSystemFlags:r,nativeEvent:a,targetContainers:[i]},t!==null&&(t=wt(t),t!==null&&ap(t)),e):(e.eventSystemFlags|=r,t=e.targetContainers,i!==null&&t.indexOf(i)===-1&&t.push(i),e)}function Tp(e,t,n,r,i){switch(t){case`focusin`:return gp=wp(gp,e,t,n,r,i),!0;case`dragenter`:return _p=wp(_p,e,t,n,r,i),!0;case`mouseover`:return vp=wp(vp,e,t,n,r,i),!0;case`pointerover`:var a=i.pointerId;return yp.set(a,wp(yp.get(a)||null,e,t,n,r,i)),!0;case`gotpointercapture`:return a=i.pointerId,bp.set(a,wp(bp.get(a)||null,e,t,n,r,i)),!0}return!1}function Ep(e){var t=Ct(e.target);if(t!==null){var n=o(t);if(n!==null){if(t=n.tag,t===13){if(t=s(n),t!==null){e.blockedOn=t,pt(e.priority,function(){op(n)});return}}else if(t===31){if(t=c(n),t!==null){e.blockedOn=t,pt(e.priority,function(){op(n)});return}}else if(t===3&&n.stateNode.current.memoizedState.isDehydrated){e.blockedOn=n.tag===3?n.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Dp(e){if(e.blockedOn!==null)return!1;for(var t=e.targetContainers;0<t.length;){var n=dp(e.nativeEvent);if(n===null){n=e.nativeEvent;var r=new n.constructor(n.type,n);cn=r,n.target.dispatchEvent(r),cn=null}else return t=wt(n),t!==null&&ap(t),e.blockedOn=n,!1;t.shift()}return!0}function Op(e,t,n){Dp(e)&&n.delete(t)}function kp(){hp=!1,gp!==null&&Dp(gp)&&(gp=null),_p!==null&&Dp(_p)&&(_p=null),vp!==null&&Dp(vp)&&(vp=null),yp.forEach(Op),bp.forEach(Op)}function Ap(e,n){e.blockedOn===n&&(e.blockedOn=null,hp||(hp=!0,t.unstable_scheduleCallback(t.unstable_NormalPriority,kp)))}var jp=null;function Mp(e){jp!==e&&(jp=e,t.unstable_scheduleCallback(t.unstable_NormalPriority,function(){jp===e&&(jp=null);for(var t=0;t<e.length;t+=3){var n=e[t],r=e[t+1],i=e[t+2];if(typeof r!=`function`){if(pp(r||n)===null)continue;break}var a=wt(n);a!==null&&(e.splice(t,3),t-=3,Ds(a,{pending:!0,data:i,method:n.method,action:r},r,i))}}))}function Np(e){function t(t){return Ap(t,e)}gp!==null&&Ap(gp,e),_p!==null&&Ap(_p,e),vp!==null&&Ap(vp,e),yp.forEach(t),bp.forEach(t);for(var n=0;n<xp.length;n++){var r=xp[n];r.blockedOn===e&&(r.blockedOn=null)}for(;0<xp.length&&(n=xp[0],n.blockedOn===null);)Ep(n),n.blockedOn===null&&xp.shift();if(n=(e.ownerDocument||e).$$reactFormReplay,n!=null)for(r=0;r<n.length;r+=3){var i=n[r],a=n[r+1],o=i[ht]||null;if(typeof a==`function`)o||Mp(n);else if(o){var s=null;if(a&&a.hasAttribute(`formAction`)){if(i=a,o=a[ht]||null)s=o.formAction;else if(pp(i)!==null)continue}else s=o.action;typeof s==`function`?n[r+1]=s:(n.splice(r,3),r-=3),Mp(n)}}}function Pp(){function e(e){e.canIntercept&&e.info===`react-transition`&&e.intercept({handler:function(){return new Promise(function(e){return i=e})},focusReset:`manual`,scroll:`manual`})}function t(){i!==null&&(i(),i=null),r||setTimeout(n,20)}function n(){if(!r&&!navigation.transition){var e=navigation.currentEntry;e&&e.url!=null&&navigation.navigate(e.url,{state:e.getState(),info:`react-transition`,history:`replace`})}}if(typeof navigation==`object`){var r=!1,i=null;return navigation.addEventListener(`navigate`,e),navigation.addEventListener(`navigatesuccess`,t),navigation.addEventListener(`navigateerror`,t),setTimeout(n,100),function(){r=!0,navigation.removeEventListener(`navigate`,e),navigation.removeEventListener(`navigatesuccess`,t),navigation.removeEventListener(`navigateerror`,t),i!==null&&(i(),i=null)}}}function Fp(e){this._internalRoot=e}Ip.prototype.render=Fp.prototype.render=function(e){var t=this._internalRoot;if(t===null)throw Error(i(409));var n=t.current;np(n,pu(),e,t,null,null)},Ip.prototype.unmount=Fp.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var t=e.containerInfo;np(e.current,2,null,e,null,null),bu(),t[gt]=null}};function Ip(e){this._internalRoot=e}Ip.prototype.unstable_scheduleHydration=function(e){if(e){var t=ft();e={blockedOn:null,target:e,priority:t};for(var n=0;n<xp.length&&t!==0&&t<xp[n].priority;n++);xp.splice(n,0,e),n===0&&Ep(e)}};var Lp=n.version;if(Lp!==`19.2.7`)throw Error(i(527,Lp,`19.2.7`));E.findDOMNode=function(e){var t=e._reactInternals;if(t===void 0)throw typeof e.render==`function`?Error(i(188)):(e=Object.keys(e).join(`,`),Error(i(268,e)));return e=d(t),e=e===null?null:p(e),e=e===null?null:e.stateNode,e};var Rp={bundleType:0,version:`19.2.7`,rendererPackageName:`react-dom`,currentDispatcherRef:T,reconcilerVersion:`19.2.7`};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<`u`){var zp=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!zp.isDisabled&&zp.supportsFiber)try{We=zp.inject(Rp),Ge=zp}catch{}}e.createRoot=function(e,t){if(!a(e))throw Error(i(299));var n=!1,r=``,o=Xs,s=Zs,c=Qs;return t!=null&&(!0===t.unstable_strictMode&&(n=!0),t.identifierPrefix!==void 0&&(r=t.identifierPrefix),t.onUncaughtError!==void 0&&(o=t.onUncaughtError),t.onCaughtError!==void 0&&(s=t.onCaughtError),t.onRecoverableError!==void 0&&(c=t.onRecoverableError)),t=ep(e,1,!1,null,null,n,r,null,o,s,c,Pp),e[gt]=t.current,Sd(e),new Fp(t)}})),g=o(((e,t)=>{function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>`u`||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!=`function`))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(e){console.error(e)}}n(),t.exports=h()})),_=c(u(),1),v=g(),y=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),b=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),x=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),ee=e=>{let t=x(e);return t.charAt(0).toUpperCase()+t.slice(1)},S={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},C=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0;return!1},te=(0,_.createContext)({}),ne=()=>(0,_.useContext)(te),re=(0,_.forwardRef)(({color:e,size:t,strokeWidth:n,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>{let{size:l=24,strokeWidth:u=2,absoluteStrokeWidth:d=!1,color:f=`currentColor`,className:p=``}=ne()??{},m=r??d?Number(n??u)*24/Number(t??l):n??u;return(0,_.createElement)(`svg`,{ref:c,...S,width:t??l??S.width,height:t??l??S.height,stroke:e??f,strokeWidth:m,className:y(`lucide`,p,i),...!a&&!C(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,_.createElement)(e,t)),...Array.isArray(a)?a:[a]])}),w=(e,t)=>{let n=(0,_.forwardRef)(({className:n,...r},i)=>(0,_.createElement)(re,{ref:i,iconNode:t,className:y(`lucide-${b(ee(e))}`,`lucide-${e}`,n),...r}));return n.displayName=ee(e),n},ie=w(`activity`,[[`path`,{d:`M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2`,key:`169zse`}]]),ae=w(`anchor`,[[`path`,{d:`M12 6v16`,key:`nqf5sj`}],[`path`,{d:`m19 13 2-1a9 9 0 0 1-18 0l2 1`,key:`y7qv08`}],[`path`,{d:`M9 11h6`,key:`1fldmi`}],[`circle`,{cx:`12`,cy:`4`,r:`2`,key:`muu5ef`}]]),oe=w(`arrow-left`,[[`path`,{d:`m12 19-7-7 7-7`,key:`1l729n`}],[`path`,{d:`M19 12H5`,key:`x3x0zl`}]]),se=w(`arrow-right`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`m12 5 7 7-7 7`,key:`xquz4c`}]]),ce=w(`book-open`,[[`path`,{d:`M12 7v14`,key:`1akyts`}],[`path`,{d:`M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z`,key:`ruj8y`}]]),le=w(`brain`,[[`path`,{d:`M12 18V5`,key:`adv99a`}],[`path`,{d:`M15 13a4.17 4.17 0 0 1-3-4 4.17 4.17 0 0 1-3 4`,key:`1e3is1`}],[`path`,{d:`M17.598 6.5A3 3 0 1 0 12 5a3 3 0 1 0-5.598 1.5`,key:`1gqd8o`}],[`path`,{d:`M17.997 5.125a4 4 0 0 1 2.526 5.77`,key:`iwvgf7`}],[`path`,{d:`M18 18a4 4 0 0 0 2-7.464`,key:`efp6ie`}],[`path`,{d:`M19.967 17.483A4 4 0 1 1 12 18a4 4 0 1 1-7.967-.517`,key:`1gq6am`}],[`path`,{d:`M6 18a4 4 0 0 1-2-7.464`,key:`k1g0md`}],[`path`,{d:`M6.003 5.125a4 4 0 0 0-2.526 5.77`,key:`q97ue3`}]]),ue=w(`calendar`,[[`path`,{d:`M8 2v4`,key:`1cmpym`}],[`path`,{d:`M16 2v4`,key:`4m81vk`}],[`rect`,{width:`18`,height:`18`,x:`3`,y:`4`,rx:`2`,key:`1hopcy`}],[`path`,{d:`M3 10h18`,key:`8toen8`}]]),T=w(`chart-no-axes-column`,[[`path`,{d:`M5 21v-6`,key:`1hz6c0`}],[`path`,{d:`M12 21V3`,key:`1lcnhd`}],[`path`,{d:`M19 21V9`,key:`unv183`}]]),E=w(`circle-check`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`m9 12 2 2 4-4`,key:`dzmm74`}]]),de=w(`clock`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 6v6l4 2`,key:`mmk7yg`}]]),fe=w(`coffee`,[[`path`,{d:`M10 2v2`,key:`7u0qdc`}],[`path`,{d:`M14 2v2`,key:`6buw04`}],[`path`,{d:`M16 8a1 1 0 0 1 1 1v8a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1h14a4 4 0 1 1 0 8h-1`,key:`pwadti`}],[`path`,{d:`M6 2v2`,key:`colzsn`}]]),pe=w(`droplet`,[[`path`,{d:`M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-4-6.5c-.5 2.5-2 4.9-4 6.5C6 11.1 5 13 5 15a7 7 0 0 0 7 7z`,key:`c7niix`}]]),me=w(`eye`,[[`path`,{d:`M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0`,key:`1nclc0`}],[`circle`,{cx:`12`,cy:`12`,r:`3`,key:`1v7zrd`}]]),he=w(`file-text`,[[`path`,{d:`M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z`,key:`1oefj6`}],[`path`,{d:`M14 2v5a1 1 0 0 0 1 1h5`,key:`wfsgrz`}],[`path`,{d:`M10 9H8`,key:`b1mrlr`}],[`path`,{d:`M16 13H8`,key:`t4e002`}],[`path`,{d:`M16 17H8`,key:`z1uh3a`}]]),D=w(`flame`,[[`path`,{d:`M12 3q1 4 4 6.5t3 5.5a1 1 0 0 1-14 0 5 5 0 0 1 1-3 1 1 0 0 0 5 0c0-2-1.5-3-1.5-5q0-2 2.5-4`,key:`1slcih`}]]),ge=w(`flower`,[[`circle`,{cx:`12`,cy:`12`,r:`3`,key:`1v7zrd`}],[`path`,{d:`M12 16.5A4.5 4.5 0 1 1 7.5 12 4.5 4.5 0 1 1 12 7.5a4.5 4.5 0 1 1 4.5 4.5 4.5 4.5 0 1 1-4.5 4.5`,key:`14wa3c`}],[`path`,{d:`M12 7.5V9`,key:`1oy5b0`}],[`path`,{d:`M7.5 12H9`,key:`eltsq1`}],[`path`,{d:`M16.5 12H15`,key:`vk5kw4`}],[`path`,{d:`M12 16.5V15`,key:`k7eayi`}],[`path`,{d:`m8 8 1.88 1.88`,key:`nxy4qf`}],[`path`,{d:`M14.12 9.88 16 8`,key:`1lst6k`}],[`path`,{d:`m8 16 1.88-1.88`,key:`h2eex1`}],[`path`,{d:`M14.12 14.12 16 16`,key:`uqkrx3`}]]),_e=w(`heart`,[[`path`,{d:`M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5`,key:`mvr1a0`}]]),ve=w(`info`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 16v-4`,key:`1dtifu`}],[`path`,{d:`M12 8h.01`,key:`e9boi3`}]]),ye=w(`layout-dashboard`,[[`rect`,{width:`7`,height:`9`,x:`3`,y:`3`,rx:`1`,key:`10lvy0`}],[`rect`,{width:`7`,height:`5`,x:`14`,y:`3`,rx:`1`,key:`16une8`}],[`rect`,{width:`7`,height:`9`,x:`14`,y:`12`,rx:`1`,key:`1hutg5`}],[`rect`,{width:`7`,height:`5`,x:`3`,y:`16`,rx:`1`,key:`ldoo1y`}]]),be=w(`message-circle`,[[`path`,{d:`M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719`,key:`1sd12s`}]]),xe=w(`message-square`,[[`path`,{d:`M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z`,key:`18887p`}]]),Se=w(`moon`,[[`path`,{d:`M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401`,key:`kfwtm`}]]),Ce=w(`pause`,[[`rect`,{x:`14`,y:`3`,width:`5`,height:`18`,rx:`1`,key:`kaeet6`}],[`rect`,{x:`5`,y:`3`,width:`5`,height:`18`,rx:`1`,key:`1wsw3u`}]]),we=w(`play`,[[`path`,{d:`M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z`,key:`10ikf1`}]]),Te=w(`plus`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`M12 5v14`,key:`s699le`}]]),Ee=w(`refresh-cw`,[[`path`,{d:`M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8`,key:`v9h5vc`}],[`path`,{d:`M21 3v5h-5`,key:`1q7to0`}],[`path`,{d:`M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16`,key:`3uifl3`}],[`path`,{d:`M8 16H3v5`,key:`1cv678`}]]),De=w(`rotate-ccw`,[[`path`,{d:`M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8`,key:`1357e3`}],[`path`,{d:`M3 3v5h5`,key:`1xhq8a`}]]),Oe=w(`send`,[[`path`,{d:`M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z`,key:`1ffxy3`}],[`path`,{d:`m21.854 2.147-10.94 10.939`,key:`12cjpa`}]]),ke=w(`smile`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M8 14s1.5 2 4 2 4-2 4-2`,key:`1y1vjs`}],[`line`,{x1:`9`,x2:`9.01`,y1:`9`,y2:`9`,key:`yxxnd0`}],[`line`,{x1:`15`,x2:`15.01`,y1:`9`,y2:`9`,key:`1p4y9e`}]]),Ae=w(`sparkles`,[[`path`,{d:`M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z`,key:`1s2grr`}],[`path`,{d:`M20 2v4`,key:`1rf3ol`}],[`path`,{d:`M22 4h-4`,key:`gwowj6`}],[`circle`,{cx:`4`,cy:`20`,r:`2`,key:`6kqj1y`}]]),je=w(`sun`,[[`circle`,{cx:`12`,cy:`12`,r:`4`,key:`4exip2`}],[`path`,{d:`M12 2v2`,key:`tus03m`}],[`path`,{d:`M12 20v2`,key:`1lh1kg`}],[`path`,{d:`m4.93 4.93 1.41 1.41`,key:`149t6j`}],[`path`,{d:`m17.66 17.66 1.41 1.41`,key:`ptbguv`}],[`path`,{d:`M2 12h2`,key:`1t8f8n`}],[`path`,{d:`M20 12h2`,key:`1q8mjw`}],[`path`,{d:`m6.34 17.66-1.41 1.41`,key:`1m8zz5`}],[`path`,{d:`m19.07 4.93-1.41 1.41`,key:`1shlcs`}]]),Me=w(`timer`,[[`line`,{x1:`10`,x2:`14`,y1:`2`,y2:`2`,key:`14vaq8`}],[`line`,{x1:`12`,x2:`15`,y1:`14`,y2:`11`,key:`17fdiu`}],[`circle`,{cx:`12`,cy:`14`,r:`8`,key:`1e1u0o`}]]),Ne=w(`touchpad`,[[`rect`,{width:`20`,height:`16`,x:`2`,y:`4`,rx:`2`,key:`18n3k1`}],[`path`,{d:`M2 14h20`,key:`myj16y`}],[`path`,{d:`M12 20v-6`,key:`1rm09r`}]]),Pe=w(`trash-2`,[[`path`,{d:`M10 11v6`,key:`nco0om`}],[`path`,{d:`M14 11v6`,key:`outv1u`}],[`path`,{d:`M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6`,key:`miytrc`}],[`path`,{d:`M3 6h18`,key:`d0wm0j`}],[`path`,{d:`M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2`,key:`e791ji`}]]),Fe=w(`trending-up`,[[`path`,{d:`M16 7h6v6`,key:`box55l`}],[`path`,{d:`m22 7-8.5 8.5-5-5L2 17`,key:`1t1m79`}]]),Ie=w(`triangle-alert`,[[`path`,{d:`m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3`,key:`wmoenq`}],[`path`,{d:`M12 9v4`,key:`juzpu7`}],[`path`,{d:`M12 17h.01`,key:`p32p05`}]]),Le=w(`volume-2`,[[`path`,{d:`M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z`,key:`uqj9uw`}],[`path`,{d:`M16 9a5 5 0 0 1 0 6`,key:`1q6k2b`}],[`path`,{d:`M19.364 18.364a9 9 0 0 0 0-12.728`,key:`ijwkga`}]]),Re=w(`volume-x`,[[`path`,{d:`M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z`,key:`uqj9uw`}],[`line`,{x1:`22`,x2:`16`,y1:`9`,y2:`15`,key:`1ewh16`}],[`line`,{x1:`16`,x2:`22`,y1:`9`,y2:`15`,key:`5ykzw1`}]]),ze=w(`wind`,[[`path`,{d:`M12.8 19.6A2 2 0 1 0 14 16H2`,key:`148xed`}],[`path`,{d:`M17.5 8a2.5 2.5 0 1 1 2 4H2`,key:`1u4tom`}],[`path`,{d:`M9.8 4.4A2 2 0 1 1 11 8H2`,key:`75valh`}]]),Be=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),O=o(((e,t)=>{t.exports=Be()}))(),Ve=({activeTab:e,setActiveTab:t,theme:n,toggleTheme:r})=>(0,O.jsxs)(`nav`,{className:`nav-wrapper`,children:[(0,O.jsx)(`a`,{href:`#main-content`,className:`skip-link`,children:`Skip to main content`}),(0,O.jsxs)(`div`,{className:`nav-container glass-panel`,children:[(0,O.jsxs)(`div`,{className:`nav-logo-area`,children:[(0,O.jsx)(ie,{className:`nav-logo-icon`,size:24}),(0,O.jsx)(`span`,{className:`nav-logo-text`,children:`ZenStudy`})]}),(0,O.jsx)(`div`,{className:`nav-links`,children:[{id:`dashboard`,label:`Dashboard`,icon:ye},{id:`tracker`,label:`Check-In`,icon:ke},{id:`analytics`,label:`Insights`,icon:T},{id:`bot`,label:`CalmBot`,icon:be},{id:`tools`,label:`Wellness Tools`,icon:ie}].map(n=>{let r=n.icon,i=e===n.id;return(0,O.jsxs)(`button`,{onClick:()=>t(n.id),className:`nav-link-btn ${i?`active`:``}`,"aria-label":`Navigate to ${n.label}`,"aria-current":i?`page`:void 0,type:`button`,children:[(0,O.jsx)(r,{size:20,className:`nav-icon`}),(0,O.jsx)(`span`,{className:`nav-label`,children:n.label}),i&&(0,O.jsx)(`span`,{className:`nav-active-dot`})]},n.id)})}),(0,O.jsx)(`div`,{className:`nav-actions`,children:(0,O.jsx)(`button`,{onClick:r,className:`theme-toggle-btn`,"aria-label":`Switch to ${n===`dark`?`light`:`dark`} theme`,type:`button`,children:n===`dark`?(0,O.jsx)(je,{size:20}):(0,O.jsx)(Se,{size:20})})})]}),(0,O.jsx)(`style`,{children:`
      ...
      `})]}),He=[{id:`JEE`,name:`JEE (Engineering)`},{id:`NEET`,name:`NEET (Medical)`},{id:`UPSC`,name:`UPSC Civil Services`},{id:`BOARD`,name:`Board Exams (10th/12th)`},{id:`CAT_GATE`,name:`CAT / GATE / Graduate Tests`},{id:`GENERAL`,name:`General Student Life`}],Ue=[`My exam score does not define my intelligence, worth, or future success.`,`I am doing the best I can, and my efforts are enough.`,`One day, one topic, one question at a time. I can handle this.`,`Breathing in, I calm my mind. Breathing out, I release my anxiety.`,`I have overcome academic challenges before, and I will navigate this one too.`,`Mistakes in mock tests are just opportunities to learn before the final day.`,`My physical and mental health are just as important as my preparation.`,`I trust my preparation and give myself permission to rest when tired.`],We={JEE:[{id:`jee_1`,category:`Mock Test Stress`,title:`De-linking Scores from Self-Worth`,content:`JEE mock tests are notoriously difficult and designed to test extreme cases. Fluctuating scores can trigger deep anxiety, making you feel unprepared.`,actionableStep:`Write down: "A mock test is a diagnostic tool, not a final judgment." For every incorrect question, label it as "conceptual gap", "calculation error", or "silly mistake" to make it objective rather than emotional.`},{id:`jee_2`,category:`Problem Solving Burnout`,title:`The "20-Minute Block" Rule`,content:`Struggling with complex Physics or Maths problems for hours can lead to intense frustration and feeling "stuck".`,actionableStep:`If a problem takes more than 20 minutes without progress, circle it, close the book, and stand up. Walk for 2 minutes or drink water. Restoring circulation helps clear mental blocks.`},{id:`jee_3`,category:`Competition Anxiety`,title:`Muting the Peer Noise`,content:`Hearing peer progress on syllabus completion or high mock percentiles can trigger intense comparison and panic.`,actionableStep:`Limit exam-related discussions with friends to 15 minutes a day. Focus on your daily targets. Your competition is only with yesterday's version of yourself.`},{id:`jee_result`,category:`Result Season Anxiety`,title:`Navigating Cutoffs and Ranks`,content:`JEE results release with percentiles and rank lists that determine college entry. Seeing a rank below expectations can induce catastrophic thoughts about career options.`,actionableStep:`Remind yourself: "Your JEE rank determines your first college, not your career trajectory." Create a list of 5 successful software engineers/founders who graduated from local non-IIT colleges.`}],NEET:[{id:`neet_1`,category:`Memorization Fatigue`,title:`Active Recall Over passive Reading`,content:`The massive Biology and Chemistry syllabus leads to visual fatigue and fear of forgetting key facts.`,actionableStep:`Instead of re-reading chapters, close the book and write down everything you remember in a mind map, or teach the concept to an imaginary student. This active retrieval builds long-term confidence.`},{id:`neet_2`,category:`Speed Panic`,title:`Managing the 200-Minute Clock`,content:`NEET requires rapid decision-making (180 questions in 200 minutes). This speed pressure often induces physical panic during practice.`,actionableStep:`Practice 10-minute speed runs with 10 easy questions. Train your nervous system to remain calm while working quickly. If a question takes over 60 seconds, skip it immediately.`},{id:`neet_3`,category:`Physical Exhaustion`,title:`Restoring Oxygen and Posture`,content:`Long hours of sitting bent over textbooks restrict oxygen flow to the brain, causing brain fog and sleepiness.`,actionableStep:`Every 45 minutes, do 5 shoulder rolls and take 3 deep belly breaths. Sit up straight to keep your energy levels steady.`},{id:`neet_result`,category:`Result Season Anxiety`,title:`The Score vs Rank Shock`,content:`NEET ranks can fluctuate wildly even for the same score due to intense competition. This can make you feel like your hard work was wasted.`,actionableStep:`Sit down and write down: "I did my best under extreme pressure. My rank is a reflection of competition density, not my intelligence." Discuss drop vs backup options with an objective advisor, not peer groups.`}],UPSC:[{id:`upsc_1`,category:`Long-term Burnout`,title:`The Marathon Mindset`,content:`Preparing for UPSC takes 1-2 years. The lack of immediate feedback and social isolation often leads to depression and feeling directionless.`,actionableStep:`Set strict weekly boundaries. Dedicate Sunday evenings entirely to non-exam activities. Treat this as a 9-to-5 job rather than a 24/7 obsession.`},{id:`upsc_2`,category:`Syllabus Overwhelm`,title:`The "One Newspaper, One Book" Filter`,content:`The endless sea of current affairs and study materials creates information overload and chronic self-doubt.`,actionableStep:`Define your resource list and stick to it. Tell yourself: "I do not need to know everything; I need to know how to structure what I do know."`},{id:`upsc_3`,category:`Uncertainty Panic`,title:`Focusing on the Input, Letting go of Output`,content:`With low success rates, the fear of "wasting years" can freeze your ability to study.`,actionableStep:`Shift your goals from output ("I must pass") to inputs ("I will complete these 3 answer-writing practices today"). Celebrate input completion.`},{id:`upsc_result`,category:`Result Season Anxiety`,title:`Dealing with the "PDF Filter"`,content:`When the UPSC final PDF results come out, not seeing your roll number after months of interviews can trigger absolute grief and identity crisis.`,actionableStep:`Give yourself 48 hours to grieve without making any decision about the next attempt. Remember: "Not clearing UPSC is not a failure of intelligence; it is a statistical filter. My GS knowledge makes me an asset anywhere."`}],BOARD:[{id:`board_1`,category:`Parental Expectations`,title:`Communicating Boundaries Gently`,content:`Pressure from parents, teachers, and relatives to score "95%+" can feel like a crushing weight.`,actionableStep:`Have a calm conversation with your parents when you are *not* studying. Share: "I am working hard. When you ask me about scores constantly, it makes me anxious and decreases my productivity. I need your support instead."`},{id:`board_2`,category:`Exam Day Fear`,title:`Writing Room Grounding`,content:`The sight of the large exam hall, strict invigilators, and rustling papers triggers high anxiety right before paper distribution.`,actionableStep:`As soon as you sit down, place both feet flat on the floor. Touch the wooden desk and notice its temperature. Breathe out slowly. Remind yourself: "This is just a paper with questions I have seen before."`},{id:`board_result`,category:`Result Season Anxiety`,title:`Managing Relatives and Comparison`,content:`Board exam result days are often accompanied by calls from relatives and comparison with neighbor scores, which can feel deeply intrusive.`,actionableStep:`Prepare a standard polite reply: "I scored X% and I am satisfied with my efforts. Thank you for asking!" Instruct your parents to handle calls if you feel overwhelmed.`}],CAT_GATE:[{id:`cat_gate_1`,category:`Career Pressure`,title:`Defusing the "Make or Break" Trap`,content:`Often written by students with jobs or final-year college stress, these exams carry heavy career stakes.`,actionableStep:`Make a backup list of 3 other viable career routes. Knowing you have alternatives immediately reduces test-day performance anxiety.`},{id:`cat_gate_2`,category:`Sectional Failure Anxiety`,title:`Resetting Between Sections`,content:`A bad performance in one section (like QA or VARC) can ruin your mindset for subsequent sections.`,actionableStep:`Develop a mental "flush" routine. When a section ends, take a deep breath, close your eyes for 5 seconds, and mentally "flush" those questions away. Focus 100% on the fresh section.`},{id:`cat_gate_result`,category:`Result Season Anxiety`,title:`Handling Shortlist Rejections`,content:`Result season is followed by shortlisting for interviews (IIMs/IITs). Getting rejected from top-choice programs can feel like a professional dead end.`,actionableStep:`Create a spreadsheet of "Plan B" programs and direct corporate roles. Remember that 70% of business/technical leaders did not attend tier-1 schools but grew through consistent industry execution.`}],GENERAL:[{id:`general_1`,category:`Sleep Deprivation`,title:`The Sleep-First Rule`,content:`Cutting sleep to 4-5 hours to study more actually degrades cognitive retention, memory retrieval, and increases baseline anxiety.`,actionableStep:`Commit to at least 7 hours of sleep. An extra hour of sleep is worth more than two hours of late-night groggy reading.`},{id:`general_2`,category:`Panic Attacks`,title:`Riding the Wave of Panic`,content:`Anxiety peaks as physical symptoms: racing heart, sweaty palms, and shallow breathing.`,actionableStep:`Do not fight the panic; acknowledge it: "My body is releasing adrenaline. It is temporary. It will peak and pass in 10 minutes." Engage in 4-4-4-4 box breathing.`},{id:`general_3`,category:`Lack of Focus`,title:`Dopamine Reset for Study Desk`,content:`Constantly checking social media or exam forums for notifications ruins focus and fuels anxiety.`,actionableStep:`Put your phone in another room or turn it completely off during study sessions. Clear your desk of everything except the subject you are currently studying.`},{id:`general_result`,category:`Result Season Anxiety`,title:`Managing Result Day Panic`,content:`The days leading up to result release are filled with extreme anxiety, physical symptoms, and sleeplessness.`,actionableStep:`Keep your routine identical to any normal day. Limit time on social media forums that speculate on result timings. Engage in visual grounding when heart rate rises.`}]},Ge=[`calm`,`energetic`,`uncertain`,`stressed`,`burned_out`],Ke=[`backlog`,`mock_tests`,`family_pressure`,`peer_comparison`,`sleep_deprived`,`time_management`,`exam_date`,`general_life`],qe=[`JEE`,`NEET`,`UPSC`,`BOARDS`,`GENERAL`],Je=/[\u0000-\u001f\u007f-\u009f]/g,Ye={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`,"`":`&#96;`};function Xe(){if(typeof window<`u`&&window.crypto&&window.crypto.getRandomValues){let e=new Uint32Array(1);return window.crypto.getRandomValues(e),e[0]/4294967295}return Math.random()}var k={userName:32,journalNote:1200,chatMessage:240,groundingEntry:300,moodLogs:100,localStorageBytes:12e4};function Ze(e){return e.replace(/[&<>"'`]/g,e=>Ye[e])}function Qe(e,t){return typeof e==`string`?Ze(e.normalize(`NFKC`).replace(Je,` `).replace(/\s{3,}/g,` `).trim().slice(0,t)):``}function $e(e,t){return typeof e==`string`?e.normalize(`NFKC`).replace(Je,` `).replace(/\s{3,}/g,` `).trim().slice(0,t):``}function et(e){return typeof e==`string`&&Ge.includes(e)}function tt(e){return typeof e==`string`&&Ke.includes(e)}function nt(e){return Qe(e,k.userName)||`Student`}function rt(e){return qe.includes(e)?e:`GENERAL`}function it(e){return e===`light`||e===`dark`?e:`dark`}function at(e){return typeof e==`number`&&Number.isInteger(e)&&e>=0&&e<=1e4?e:0}function ot(e){if(!e||typeof e!=`object`)return null;let t=e;if(!et(t.mood))return null;let n=typeof t.date==`string`?Date.parse(t.date):NaN,r=Number.isFinite(n)?new Date(n).toISOString():new Date().toISOString(),i=t.rating,a=typeof i==`number`&&Number.isInteger(i)&&i>=1&&i<=5?i:3,o=Array.isArray(t.triggers)?Array.from(new Set(t.triggers.filter(tt))):[];return{id:$e(t.id,64)||crypto.randomUUID(),date:r,mood:t.mood,rating:a,triggers:o,notes:Qe(t.notes,k.journalNote)}}function st(e){return Array.isArray(e)?e.map(ot).filter(e=>!!e).slice(0,k.moodLogs):[]}function ct(e,t=k.localStorageBytes){return new Blob([JSON.stringify(e)]).size<=t}function lt(e){return e instanceof Error&&e.name||`ApplicationError`}var ut=[{id:`calm`,label:`Calm & Focused`,emoji:`🌿`,rating:5,color:`#0d9488`},{id:`energetic`,label:`Energized`,emoji:`⚡`,rating:4,color:`#f59e0b`},{id:`uncertain`,label:`Uncertain / Doubting`,emoji:`🌫️`,rating:3,color:`#a855f7`},{id:`stressed`,label:`Stressed / Anxious`,emoji:`😰`,rating:2,color:`#6366f1`},{id:`burned_out`,label:`Burned Out`,emoji:`🔋`,rating:1,color:`#ef4444`}],dt=[{id:`backlog`,label:`Syllabus Backlog`},{id:`mock_tests`,label:`Mock Test Scores`},{id:`family_pressure`,label:`Family Expectations`},{id:`peer_comparison`,label:`Comparing to Peers`},{id:`sleep_deprived`,label:`Lack of Sleep`},{id:`time_management`,label:`Time Management`},{id:`exam_date`,label:`Exam Date Approaching`},{id:`general_life`,label:`Non-Academic Issues`}],ft=Object.fromEntries(ut.map(e=>[e.id,e.label])),pt=Object.fromEntries(dt.map(e=>[e.id,e.label])),mt=({userName:e,setUserName:t,targetExam:n,setTargetExam:r,moodLogs:i,setActiveTab:a,pomodoroCount:o})=>{let[s]=(0,_.useState)(()=>Ue[new Date().getDate()%Ue.length]),[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)(e),f=e=>{e.preventDefault(),t(nt(u)),l(!1)},p=()=>{if(i.length===0)return 0;let e=[...i].sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()),t=0,n=new Date;n.setHours(0,0,0,0);for(let r=0;r<e.length;r++){let i=new Date(e[r].date);i.setHours(0,0,0,0);let a=Math.abs(n.getTime()-i.getTime()),o=Math.ceil(a/(1e3*60*60*24));if(o===0)t++,n.setDate(n.getDate()-1);else if(o===1)t++,n=i,n.setDate(n.getDate()-1);else break}return t},m=()=>i.length===0?`No check-ins yet`:ft[[...i].sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime())[0].mood]||`Recorded mood`,h=We[n]||We.GENERAL;return(0,O.jsxs)(`div`,{className:`dashboard-layout slide-in`,children:[(0,O.jsxs)(`header`,{className:`welcome-banner glass-panel`,children:[(0,O.jsxs)(`div`,{className:`welcome-text-area`,children:[c?(0,O.jsxs)(`form`,{onSubmit:f,className:`name-form`,children:[(0,O.jsx)(`input`,{"aria-label":`Display name`,type:`text`,value:u,onChange:e=>d($e(e.target.value,k.userName)),className:`glass-input name-input`,maxLength:32,autoFocus:!0}),(0,O.jsx)(`button`,{type:`submit`,className:`glass-btn glass-btn-primary save-btn`,children:`Save`})]}):(0,O.jsxs)(`h2`,{className:`welcome-title`,children:[`Welcome, `,(0,O.jsx)(`button`,{type:`button`,className:`highlight-text`,onClick:()=>l(!0),title:`Edit name`,children:e}),`!`]}),(0,O.jsxs)(`p`,{className:`welcome-sub`,children:[`Your prep journey for `,(0,O.jsx)(`span`,{className:`exam-badge`,children:He.find(e=>e.id===n)?.name||n}),` is a marathon, not a sprint. Take it one breath at a time.`]})]}),(0,O.jsxs)(`div`,{className:`exam-select-area`,children:[(0,O.jsx)(`label`,{htmlFor:`exam-select`,className:`select-label`,children:`Focus Exam:`}),(0,O.jsx)(`select`,{id:`exam-select`,value:n,onChange:e=>r(rt(e.target.value)),className:`glass-input exam-dropdown`,children:He.map(e=>(0,O.jsx)(`option`,{value:e.id,children:e.name},e.id))})]})]}),(0,O.jsxs)(`section`,{className:`affirmation-card glass-panel`,children:[(0,O.jsxs)(`div`,{className:`card-header`,children:[(0,O.jsx)(Ae,{className:`affirmation-icon`,size:20}),(0,O.jsx)(`h3`,{children:`Affirmation for Today`})]}),(0,O.jsxs)(`p`,{className:`affirmation-text`,children:[`"`,s,`"`]})]}),(0,O.jsxs)(`div`,{className:`grid-2 dashboard-grid`,children:[(0,O.jsxs)(`section`,{className:`stats-panel glass-panel`,children:[(0,O.jsx)(`h3`,{children:`Your Wellness Metrics`}),(0,O.jsxs)(`div`,{className:`stats-container`,children:[(0,O.jsxs)(`div`,{className:`stat-card`,children:[(0,O.jsx)(D,{className:`stat-icon streak-icon`,size:24}),(0,O.jsxs)(`div`,{className:`stat-data`,children:[(0,O.jsxs)(`span`,{className:`stat-value`,children:[p(),` Days`]}),(0,O.jsx)(`span`,{className:`stat-label`,children:`Check-In Streak`})]})]}),(0,O.jsxs)(`div`,{className:`stat-card`,children:[(0,O.jsx)(le,{className:`stat-icon mood-icon`,size:24}),(0,O.jsxs)(`div`,{className:`stat-data`,children:[(0,O.jsx)(`span`,{className:`stat-value`,children:m()}),(0,O.jsx)(`span`,{className:`stat-label`,children:`Last Recorded Mood`})]})]}),(0,O.jsxs)(`div`,{className:`stat-card`,children:[(0,O.jsx)(E,{className:`stat-icon study-icon`,size:24}),(0,O.jsxs)(`div`,{className:`stat-data`,children:[(0,O.jsxs)(`span`,{className:`stat-value`,children:[o,` Sessions`]}),(0,O.jsx)(`span`,{className:`stat-label`,children:`Focus Timers Completed`})]})]})]})]}),(0,O.jsxs)(`section`,{className:`actions-panel glass-panel`,children:[(0,O.jsx)(`h3`,{children:`Quick-Start Tools`}),(0,O.jsxs)(`div`,{className:`quick-actions-list`,children:[(0,O.jsxs)(`button`,{onClick:()=>a(`tracker`),className:`action-row`,children:[(0,O.jsxs)(`div`,{className:`action-info`,children:[(0,O.jsx)(`span`,{className:`action-title`,children:`Log Today's Mood`}),(0,O.jsx)(`span`,{className:`action-desc`,children:`Check-in triggers and write your journal`})]}),(0,O.jsx)(se,{size:18})]}),(0,O.jsxs)(`button`,{onClick:()=>a(`bot`),className:`action-row`,children:[(0,O.jsxs)(`div`,{className:`action-info`,children:[(0,O.jsx)(`span`,{className:`action-title`,children:`Chat with CalmBot`}),(0,O.jsx)(`span`,{className:`action-desc`,children:`Talk through exam anxieties using CBT exercises`})]}),(0,O.jsx)(se,{size:18})]}),(0,O.jsxs)(`button`,{onClick:()=>a(`tools`),className:`action-row`,children:[(0,O.jsxs)(`div`,{className:`action-info`,children:[(0,O.jsx)(`span`,{className:`action-title`,children:`Mindfulness Exercises`}),(0,O.jsx)(`span`,{className:`action-desc`,children:`Box breathing, 5-4-3-2-1 technique, study timer`})]}),(0,O.jsx)(se,{size:18})]})]})]})]}),(0,O.jsxs)(`section`,{className:`exam-tips-section glass-panel`,children:[(0,O.jsxs)(`div`,{className:`tips-section-header`,children:[(0,O.jsx)(ce,{size:22,className:`tips-icon`}),(0,O.jsxs)(`h3`,{children:[`Stress Relief Guide for `,He.find(e=>e.id===n)?.name]})]}),(0,O.jsx)(`div`,{className:`tips-grid`,children:h.map(e=>(0,O.jsxs)(`div`,{className:`tip-card`,children:[(0,O.jsxs)(`div`,{className:`tip-header-row`,children:[(0,O.jsx)(`span`,{className:`tip-category-badge`,children:e.category}),(0,O.jsx)(`h4`,{className:`tip-title`,children:e.title})]}),(0,O.jsx)(`p`,{className:`tip-content`,children:e.content}),(0,O.jsxs)(`div`,{className:`action-step-container`,children:[(0,O.jsxs)(`div`,{className:`action-step-header`,children:[(0,O.jsx)(fe,{size:14,className:`action-icon`}),(0,O.jsx)(`span`,{children:`Coping Exercise`})]}),(0,O.jsx)(`p`,{className:`action-step-text`,children:e.actionableStep})]})]},e.id))})]}),(0,O.jsx)(`style`,{children:`
        .dashboard-layout {
          display: flex;
          flex-direction: column;
          gap: 24px;
      ...
      `})]})},A=[{name:`General CBT Reflection`,text:`1. What happened to trigger your stress?
- 
...
- `},{name:`Mock Test Analysis`,text:`1. What was your mock test score/result?
- 
...
- `},{name:`Gratitude & Control`,text:`1. What are 3 things within your direct control today?
- 
...
- `}],ht=({moodLogs:e,onAddLog:t,onDeleteLog:n})=>{let[r,i]=(0,_.useState)(``),[a,o]=(0,_.useState)([]),[s,c]=(0,_.useState)(``),[l,u]=(0,_.useState)(-1),[d,f]=(0,_.useState)(``),p=e=>{if(!et(e)){f(`Invalid mood selection.`);return}i(e),f(``)},m=e=>{tt(e)&&o(t=>t.includes(e)?t.filter(t=>t!==e):[...t,e])},h=e=>{c(e===-1?``:$e(A[e].text,k.journalNote)),u(e)},g=e=>{if(e.preventDefault(),!r){f(`Please select a mood that represents your state.`);return}let n=ut.find(e=>e.id===r),l=Qe(s,k.journalNote);t({id:crypto.randomUUID(),date:new Date().toISOString(),mood:r,rating:n?n.rating:3,triggers:a,notes:l}),i(``),o([]),c(``),u(-1),f(``)},v=e=>new Date(e).toLocaleDateString(void 0,{weekday:`short`,month:`short`,day:`numeric`,hour:`2-digit`,minute:`2-digit`});return(0,O.jsxs)(`div`,{className:`mood-tracker-layout slide-in`,children:[(0,O.jsxs)(`div`,{className:`grid-2`,children:[(0,O.jsxs)(`section`,{className:`form-panel glass-panel`,children:[(0,O.jsx)(`h2`,{className:`panel-title`,children:`Daily Mental Check-In`}),(0,O.jsx)(`p`,{className:`panel-subtitle`,children:`Pause for a moment to evaluate your current state. Tracking helps identify patterns.`}),(0,O.jsxs)(`form`,{onSubmit:g,className:`checkin-form`,children:[(0,O.jsxs)(`div`,{className:`form-section`,children:[(0,O.jsx)(`label`,{className:`section-label`,id:`mood-selector-label`,children:`1. How are you feeling right now?`}),(0,O.jsx)(`div`,{className:`mood-options-grid`,role:`radiogroup`,"aria-labelledby":`mood-selector-label`,children:ut.map(e=>(0,O.jsxs)(`button`,{type:`button`,onClick:()=>p(e.id),className:`mood-card-btn ${r===e.id?`active`:``}`,style:{"--mood-color":e.color},role:`radio`,"aria-checked":r===e.id,children:[(0,O.jsx)(`span`,{className:`mood-emoji`,role:`img`,"aria-label":e.label,children:e.emoji}),(0,O.jsx)(`span`,{className:`mood-btn-label`,children:e.label})]},e.id))})]}),(0,O.jsxs)(`div`,{className:`form-section`,children:[(0,O.jsx)(`label`,{className:`section-label`,id:`trigger-selector-label`,children:`2. Identify what is contributing to your stress (Triggers):`}),(0,O.jsx)(`div`,{className:`triggers-flex`,"aria-labelledby":`trigger-selector-label`,children:dt.map(e=>{let t=a.includes(e.id);return(0,O.jsxs)(`button`,{type:`button`,onClick:()=>m(e.id),className:`trigger-tag-btn ${t?`active`:``}`,"aria-pressed":t,children:[t&&(0,O.jsx)(Te,{size:12,className:`tag-icon`}),e.label]},e.id)})})]}),(0,O.jsxs)(`div`,{className:`form-section`,children:[(0,O.jsxs)(`div`,{className:`journal-header-row`,children:[(0,O.jsx)(`label`,{className:`section-label`,children:`3. Emotion Reflection & Journaling`}),(0,O.jsxs)(`div`,{className:`template-selectors`,children:[(0,O.jsx)(`span`,{className:`template-label`,children:`Use Guide:`}),A.map((e,t)=>(0,O.jsx)(`button`,{type:`button`,onClick:()=>h(t),className:`template-btn ${l===t?`active`:``}`,children:e.name.split(` `)[0]},t)),l!==-1&&(0,O.jsx)(`button`,{type:`button`,onClick:()=>h(-1),className:`template-btn clear-tpl`,children:`Clear`})]})]}),(0,O.jsx)(`textarea`,{value:s,onChange:e=>c($e(e.target.value,k.journalNote)),placeholder:`Write down your thoughts. If using a guide above, answer the prompts to challenge stressful thoughts...`,className:`glass-input journal-textarea`,"aria-label":`Emotion reflection journal`,maxLength:k.journalNote,rows:8})]}),d&&(0,O.jsxs)(`div`,{className:`error-message`,children:[(0,O.jsx)(Ie,{size:16}),(0,O.jsx)(`span`,{children:d})]}),(0,O.jsx)(`button`,{type:`submit`,className:`glass-btn glass-btn-primary submit-checkin`,children:`Save Check-In Entry`})]})]}),(0,O.jsxs)(`section`,{className:`history-panel glass-panel`,children:[(0,O.jsx)(`h2`,{className:`panel-title`,children:`Your Wellness History`}),(0,O.jsx)(`p`,{className:`panel-subtitle`,children:`Review your past logs to see how your emotions evolve over time.`}),(0,O.jsx)(`div`,{className:`logs-history-list`,children:e.length===0?(0,O.jsxs)(`div`,{className:`empty-history`,children:[(0,O.jsx)(ke,{size:48,className:`empty-icon`}),(0,O.jsx)(`p`,{children:`No check-in logs recorded yet.`}),(0,O.jsx)(`span`,{children:`Logs you save will appear here in reverse chronological order.`})]}):[...e].sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()).map(e=>{let t=ut.find(t=>t.id===e.mood);return(0,O.jsxs)(`div`,{className:`history-card`,children:[(0,O.jsxs)(`div`,{className:`history-card-header`,children:[(0,O.jsxs)(`div`,{className:`history-mood-badge`,children:[(0,O.jsx)(`span`,{className:`history-emoji`,children:t?.emoji||`📝`}),(0,O.jsxs)(`div`,{className:`history-mood-meta`,children:[(0,O.jsx)(`span`,{className:`history-mood-name`,children:t?.label||e.mood}),(0,O.jsxs)(`span`,{className:`history-date-span`,children:[(0,O.jsx)(ue,{size:12,className:`meta-icon`}),v(e.date)]})]})]}),(0,O.jsx)(`button`,{onClick:()=>n(e.id),className:`delete-log-btn`,"aria-label":`Delete check-in log`,children:(0,O.jsx)(Pe,{size:16})})]}),e.triggers&&e.triggers.length>0&&(0,O.jsx)(`div`,{className:`history-card-triggers`,children:e.triggers.map(e=>{let t=dt.find(t=>t.id===e);return(0,O.jsx)(`span`,{className:`history-trigger-badge`,children:t?t.label:e},e)})}),e.notes&&(0,O.jsxs)(`div`,{className:`history-card-notes`,children:[(0,O.jsx)(he,{size:12,className:`note-icon`}),(0,O.jsx)(`p`,{className:`note-text-preview`,children:e.notes})]})]},e.id)})})]})]}),(0,O.jsx)(`style`,{children:`
        .mood-tracker-layout {
          display: flex;
          flex-direction: column;
          gap: 24px;
      ...
      `})]})},gt={5:`🌿 Calm`,4:`⚡ Energized`,3:`🌫️ Uncertain`,2:`😰 Stressed`,1:`🔋 Burned Out`},_t=({moodLogs:e})=>{let[t,n]=(0,_.useState)(null);if(e.length<2)return(0,O.jsxs)(`div`,{className:`analytics-empty glass-panel slide-in`,children:[(0,O.jsx)(T,{size:64,className:`empty-chart-icon`}),(0,O.jsx)(`h2`,{children:`Not Enough Data Yet`}),(0,O.jsx)(`p`,{children:`We need at least 2 check-in entries to generate trend lines and trigger correlation analyses.`}),(0,O.jsx)(`span`,{className:`empty-sub`,children:`Head over to the Check-In tab to log how you are feeling right now!`})]});let r=[...e].sort((e,t)=>new Date(e.date).getTime()-new Date(t.date).getTime()).slice(-10),i=e.length,a=e.reduce((e,t)=>e+t.rating,0)/i,o={};e.forEach(e=>{e.triggers&&Array.isArray(e.triggers)&&e.triggers.forEach(e=>{o[e]=(o[e]||0)+1})});let s=Object.entries(o).map(([e,t])=>({id:e,name:pt[e]||`Recorded trigger`,count:t,percentage:Math.round(t/i*100)})).sort((e,t)=>t.count-e.count),c=s[0],l=c?`${c.name} (${c.count} times)`:`None recorded`,u=(e,t)=>({x:50+e/(r.length-1)*520,y:210-(t-1)/4*190}),d=``,f=``,p=[];return r.forEach((e,t)=>{let n=u(t,e.rating),i=new Date(e.date).toLocaleDateString(void 0,{month:`short`,day:`numeric`});p.push({x:n.x,y:n.y,date:i,rating:e.rating,mood:gt[e.rating]||e.mood}),t===0?(d=`M ${n.x} ${n.y}`,f=`M ${n.x} 210 L ${n.x} ${n.y}`):(d+=` L ${n.x} ${n.y}`,f+=` L ${n.x} ${n.y}`),t===r.length-1&&(f+=` L ${n.x} 210 Z`)}),(0,O.jsxs)(`div`,{className:`analytics-layout slide-in`,children:[(0,O.jsxs)(`section`,{className:`grid-3 stats-summary-cards`,children:[(0,O.jsxs)(`div`,{className:`analytics-card glass-panel`,children:[(0,O.jsx)(`span`,{className:`card-label`,children:`Average Wellness Index`}),(0,O.jsxs)(`span`,{className:`card-value`,children:[a.toFixed(1),` / 5.0`]}),(0,O.jsx)(`span`,{className:`card-sub`,children:a>=4?`🌿 Doing Great!`:a>=3?`🌫️ Fair`:`😰 Highly Stressed`})]}),(0,O.jsxs)(`div`,{className:`analytics-card glass-panel`,children:[(0,O.jsx)(`span`,{className:`card-label`,children:`Top Stress Trigger`}),(0,O.jsx)(`span`,{className:`card-value top-trigger-val`,children:c?c.name:`N/A`}),(0,O.jsx)(`span`,{className:`card-sub`,children:l})]}),(0,O.jsxs)(`div`,{className:`analytics-card glass-panel`,children:[(0,O.jsx)(`span`,{className:`card-label font-title`,children:`Total Records`}),(0,O.jsxs)(`span`,{className:`card-value`,children:[i,` Entries`]}),(0,O.jsx)(`span`,{className:`card-sub`,children:`Tracking consistency active`})]})]}),(0,O.jsxs)(`div`,{className:`grid-2 main-analytics-grid`,children:[(0,O.jsxs)(`section`,{className:`chart-panel glass-panel`,children:[(0,O.jsxs)(`div`,{className:`panel-header`,children:[(0,O.jsx)(Fe,{size:20,className:`header-icon primary-color`}),(0,O.jsx)(`h3`,{children:`Mood Trend (Last 10 entries)`})]}),(0,O.jsxs)(`div`,{className:`svg-container`,children:[(0,O.jsxs)(`svg`,{viewBox:`0 0 600 250`,className:`trend-svg`,role:`img`,"aria-label":`Mood trend chart for recent check-ins`,children:[(0,O.jsx)(`defs`,{children:(0,O.jsxs)(`linearGradient`,{id:`chartAreaGradient`,x1:`0`,y1:`0`,x2:`0`,y2:`1`,children:[(0,O.jsx)(`stop`,{offset:`0%`,stopColor:`var(--color-primary)`,stopOpacity:`0.4`}),(0,O.jsx)(`stop`,{offset:`100%`,stopColor:`var(--color-primary)`,stopOpacity:`0.0`})]})}),[1,2,3,4,5].map(e=>{let t=210-(e-1)/4*190;return(0,O.jsxs)(`g`,{className:`grid-line-group`,children:[(0,O.jsx)(`line`,{x1:50,y1:t,x2:570,y2:t,stroke:`var(--glass-border)`,strokeDasharray:`4 4`}),(0,O.jsx)(`text`,{x:38,y:t+4,className:`y-axis-label`,textAnchor:`end`,children:e})]},e)}),p.map((e,t)=>(0,O.jsx)(`text`,{x:e.x,y:234,className:`x-axis-label`,textAnchor:`middle`,children:e.date},t)),(0,O.jsx)(`path`,{d:f,fill:`url(#chartAreaGradient)`}),(0,O.jsx)(`path`,{d,fill:`none`,stroke:`var(--color-primary)`,strokeWidth:`3`,strokeLinecap:`round`,strokeLinejoin:`round`}),p.map((e,r)=>(0,O.jsxs)(`g`,{onMouseEnter:()=>n(r),onMouseLeave:()=>n(null),style:{cursor:`pointer`},children:[t===r&&(0,O.jsx)(`circle`,{cx:e.x,cy:e.y,r:`9`,fill:`var(--color-primary-glow)`,stroke:`var(--color-primary)`,strokeWidth:`1.5`}),(0,O.jsx)(`circle`,{cx:e.x,cy:e.y,r:`5`,fill:t===r?`var(--color-secondary)`:`var(--color-primary)`,stroke:`var(--text-primary)`,strokeWidth:`1.5`,tabIndex:0,"aria-label":`${e.date}: ${e.mood}, wellness index ${e.rating} out of 5`,onFocus:()=>n(r),onBlur:()=>n(null)})]},r))]}),t!==null&&(0,O.jsxs)(`div`,{className:`chart-tooltip glass-panel`,style:{left:`${p[t].x/600*100}%`,top:`${p[t].y/250*100-32}%`},children:[(0,O.jsx)(`span`,{className:`tooltip-date`,children:p[t].date}),(0,O.jsxs)(`span`,{className:`tooltip-mood`,children:[`Mood: `,p[t].mood]}),(0,O.jsxs)(`span`,{className:`tooltip-rating`,children:[`Index: `,p[t].rating,`/5`]})]})]}),(0,O.jsxs)(`div`,{className:`chart-legend-info`,children:[(0,O.jsx)(ve,{size:14}),(0,O.jsx)(`span`,{children:`Score Mapping: 5 = Calm & Focused, 1 = Exhausted. Hover dots to see details.`})]})]}),(0,O.jsxs)(`section`,{className:`triggers-panel glass-panel`,children:[(0,O.jsxs)(`div`,{className:`panel-header`,children:[(0,O.jsx)(ie,{size:20,className:`header-icon secondary-color`}),(0,O.jsx)(`h3`,{children:`Stress Trigger Prevalence`})]}),(0,O.jsx)(`div`,{className:`triggers-chart-list`,children:s.length===0?(0,O.jsx)(`div`,{className:`empty-triggers`,children:(0,O.jsx)(`p`,{children:`No triggers recorded in your logs yet.`})}):s.map(e=>(0,O.jsxs)(`div`,{className:`trigger-bar-row`,children:[(0,O.jsxs)(`div`,{className:`trigger-bar-meta`,children:[(0,O.jsx)(`span`,{className:`trigger-bar-name`,children:e.name}),(0,O.jsxs)(`span`,{className:`trigger-bar-pct`,children:[e.count,` times (`,e.percentage,`%)`]})]}),(0,O.jsx)(`div`,{className:`trigger-bar-container`,children:(0,O.jsx)(`div`,{className:`trigger-bar-fill`,style:{width:`${e.percentage}%`}})})]},e.id))})]})]}),(0,O.jsx)(`style`,{children:`
        .analytics-layout {
          display: flex;
          flex-direction: column;
          gap: 24px;
      ...
      `})]})},vt={start:{id:`start`,text:`Hello! I'm CalmBot, your wellness companion. Preparing for major exams can be incredibly draining, both mentally and physically. What's on your mind right now? Select the topic that resonates most with your current feelings:`,options:[{text:`I scored poorly on a mock test / practice exam.`,nextStepId:`mock_1`},{text:`I'm overwhelmed by my syllabus backlog.`,nextStepId:`backlog_1`},{text:`I feel like I will fail and disappoint my family/peers.`,nextStepId:`pressure_1`},{text:`I feel completely exhausted and burned out.`,nextStepId:`burnout_1`},{text:`I just need a quick breathing or grounding exercise.`,nextStepId:`exercise_choice`}]},mock_1:{id:`mock_1`,text:`A low mock score can feel like a punch in the stomach. It often triggers the automatic thought: 'This score proves I am going to fail the real exam.' In CBT, we call this 'fortune-telling' or catastrophizing. Tell me: what is the main negative thought you're having about this score?`,requiresTextInput:!0,textPlaceholder:`e.g., I won't clear the cutoff, I am not smart enough...`,textSubmitButtonText:`Submit Thought`,textInputKey:`automatic_thought`,options:[{text:`I'd rather select a common thought.`,nextStepId:`mock_select_thought`}]},mock_select_thought:{id:`mock_select_thought`,text:`Select the thought that feels closest to what you're feeling:`,options:[{text:`I am consistently scoring low, so I will never clear the cutoffs.`,nextStepId:`mock_2`},{text:`I made silly mistakes again, I have no exam temperament.`,nextStepId:`mock_2`},{text:`Everyone else is scoring better than me, I am falling behind.`,nextStepId:`mock_2`}]},mock_2:{id:`mock_2`,text:`Thank you for sharing that. Let's look at the facts. In CBT, we separate *feelings* from *facts*. Is a mock test designed to mirror your absolute final limit, or is it a diagnostic tool designed to reveal gaps?`,options:[{text:`It's a diagnostic tool, but seeing low marks still hurts.`,nextStepId:`mock_3`},{text:`I feel like it reflects my actual ability on the final day.`,nextStepId:`mock_4`}]},mock_3:{id:`mock_3`,text:`Exactly. It is a diagnostic tool. Every mistake you make in a mock test is a bug caught *before* production—it is a question you will get *right* in the actual exam because you learned from it today. Let's write down a more balanced thought: 'This mock test showed me what I need to revise. It does not dictate my future score.' How does that thought feel?`,options:[{text:`It makes sense. I can focus on revising the weak areas.`,nextStepId:`mock_action`},{text:`It's hard to believe it fully, but it helps.`,nextStepId:`mock_action`}]},mock_4:{id:`mock_4`,text:`It is normal to feel that way. Let's look at past toppers: almost every single one of them had terrible mock test scores at some point. The difference is they used those scores to patch their weaknesses rather than giving up. Let's write down a balanced alternative: 'My score today is a snapshot of my current knowledge, not a prediction of my final result. I have time to learn.' Ready to take a constructive action?`,options:[{text:`Yes, what should I do?`,nextStepId:`mock_action`}]},mock_action:{id:`mock_action`,text:`Excellent. Your action step: Choose exactly THREE questions you got wrong in that mock test. Write down their solutions in a 'mistake journal'. Do not look at the rest of the paper today. Can you commit to just doing this one task?`,options:[{text:`Yes, I will do that now.`,nextStepId:`finish_flow`},{text:`I'd like to do a quick breathing exercise first to calm down.`,nextStepId:`run_breathing`}]},backlog_1:{id:`backlog_1`,text:`Syllabus backlog is the #1 stressor for students. Looking at a mountain of unread chapters triggers 'all-or-nothing thinking': 'If I cannot complete 100% of the syllabus, I will fail.' Let's break this down. What is the biggest backlog topic that is stressing you out right now?`,requiresTextInput:!0,textPlaceholder:`e.g., Organic chemistry, Rotational mechanics, UPSC GS Paper 3...`,textSubmitButtonText:`Define Backlog`,textInputKey:`backlog_topic`,options:[{text:`It's just everything. The whole syllabus is a mess.`,nextStepId:`backlog_all`}]},backlog_all:{id:`backlog_all`,text:`When everything feels like a mess, we experience mental paralysis. Let's challenge the idea that you need 100% syllabus coverage. In most competitive exams, you can secure an excellent rank by scoring 60-70% if you do it with high accuracy. Do you think it's better to do 70% of the syllabus thoroughly, or 100% in a rush?`,options:[{text:`Doing 70% thoroughly is definitely better.`,nextStepId:`backlog_2`},{text:`I feel like I still need 100% to clear the cutoffs.`,nextStepId:`backlog_3`}]},backlog_2:{id:`backlog_2`,text:`Spot on! Accuracy beats coverage. Let's reframe: 'I do not need to study everything to succeed. I will focus on high-yield topics first.' Let's create an actionable micro-task. What is one high-yield topic from your backlog you can study for just 25 minutes today?`,requiresTextInput:!0,textPlaceholder:`e.g. Modern Physics, Cell biology, Indian Polity intro...`,textSubmitButtonText:`Submit Micro-task`,textInputKey:`micro_task`,options:[{text:`I want to start with a small revision instead.`,nextStepId:`backlog_action`}]},backlog_3:{id:`backlog_3`,text:`It is a common fear, but statistical analysis of cutoffs shows that absolute perfection is never required. Let's shift our focus from the massive backlog to the present moment. You cannot study 5 chapters today, but you *can* study 1 topic. Let's reframe: 'I will focus on what I can do today, rather than stressing about what I didn't do in the past.' Ready to do a 25-minute Pomodoro focus session?`,options:[{text:`Yes, let's start a study session.`,nextStepId:`run_timer`},{text:`I want a quick action tip first.`,nextStepId:`backlog_action`}]},backlog_action:{id:`backlog_action`,text:`Your action step: Open your study materials for just ONE specific topic from your backlog. Put away all other books. Set a timer for 25 minutes and study ONLY that topic. When the timer rings, you are free to stop. Would you like to use our Pomodoro Timer for this?`,options:[{text:`Yes, take me to the Study Timer.`,nextStepId:`run_timer`},{text:`I'll do it on my own. Thank you!`,nextStepId:`finish_flow`}]},pressure_1:{id:`pressure_1`,text:`Fear of disappointing parents or feeling inferior to peers is a heavy burden. It triggers 'mind-reading': 'If I don't clear this, my parents will think I am a failure and my friends will look down on me.' Have you talked to your family about how this pressure makes you feel?`,options:[{text:`No, they wouldn't understand or it might stress them more.`,nextStepId:`pressure_2`},{text:`Yes, but they still continue to push me.`,nextStepId:`pressure_3`},{text:`My biggest pressure is actually comparing myself to my top-scoring peers.`,nextStepId:`pressure_peer`}]},pressure_2:{id:`pressure_2`,text:`That's understandable. Often, parents push because they are anxious about your future, not because they will stop loving you if you fail. Let's write down a balanced perspective: 'My parents' anxiety is about their care for my future, but my performance is my own journey. I can only do my best.' Does this shift how you look at their words?`,options:[{text:`Yes, it helps me separate their anxiety from my worth.`,nextStepId:`pressure_action`},{text:`It's still hard, but I see the logic.`,nextStepId:`pressure_action`}]},pressure_3:{id:`pressure_3`,text:`It is incredibly tough when family pushes despite your explanations. Remember: you are the one sitting in the exam, not them. You cannot control their reaction, but you *can* control how much of their expectations you carry. Let's establish a mental boundary: 'I am writing this exam for my growth, not to purchase my parents' approval. My worth is non-negotiable.' Ready to try a grounding exercise to release this external tension?`,options:[{text:`Yes, let's do a grounding exercise.`,nextStepId:`run_grounding`},{text:`I'd like to see the action step for expectations.`,nextStepId:`pressure_action`}]},pressure_peer:{id:`pressure_peer`,text:`Peer comparison is a trap. In the social media/WhatsApp era, everyone shares their best scores and hides their struggles. You are comparing your *insides* (your anxiety, doubts, backlogs) with their polished *outsides*. Let's reframe: 'I am on my own track. Their speed has nothing to do with my success.' How does that feel?`,options:[{text:`It's true. I don't know their real struggles.`,nextStepId:`pressure_action`},{text:`I need to stop asking them about their scores.`,nextStepId:`pressure_action`}]},pressure_action:{id:`pressure_action`,text:`Your action step: Write down on a piece of paper: 'I am doing this exam for myself. My worth is not tied to a rank.' Fold it and keep it on your desk. For the next 24 hours, mute all exam-related peer group chats. Can you do this for your peace of mind?`,options:[{text:`Yes, I will mute the groups and write the note.`,nextStepId:`finish_flow`},{text:`Let's do a quick box breathing to seal this boundary.`,nextStepId:`run_breathing`}]},burnout_1:{id:`burnout_1`,text:`Burnout is physical and mental defense. Your brain is telling you: 'I have reached my capacity, and I need rest.' When we force ourselves to study through burnout, our efficiency drops to near-zero, and we feel guilt. What physical symptoms of burnout are you feeling?`,options:[{text:`Constant headaches, eye strain, and general physical tiredness.`,nextStepId:`burnout_2`},{text:`I sit with my books open but cannot process a single sentence.`,nextStepId:`burnout_2`},{text:`Insomnia, racing thoughts, and waking up tired.`,nextStepId:`burnout_sleep`}]},burnout_sleep:{id:`burnout_sleep`,text:`Exam insomnia is highly common. The racing mind prevents the brain from entering recovery mode. Remember: 1 hour of sleep is worth 3 hours of half-awake midnight studying. Let's make a deal. If you cannot sleep, will you try box breathing instead of looking at your phone or textbooks?`,options:[{text:`Yes, I will try breathing next time.`,nextStepId:`burnout_2`},{text:`It's hard, but I will try to keep books away before sleep.`,nextStepId:`burnout_2`}]},burnout_2:{id:`burnout_2`,text:`Rest is not a reward for studying; it is a *requirement* for studying. Just like a phone needs charging, your brain needs downtime to consolidate memories. Let's reframe: 'Resting is productive because it restores my brain's capability to learn.' Can you give yourself permission to take a guilt-free rest today?`,options:[{text:`Yes, I need to take a break.`,nextStepId:`burnout_action`},{text:`I feel too guilty when I don't study.`,nextStepId:`burnout_guilt`}]},burnout_guilt:{id:`burnout_guilt`,text:`Guilt is just a habit. Look at it mathematically: 2 hours of focused study with a refreshed brain yields *more* retention than 6 hours of staring blankly at a page while exhausted. Resting *is* preparing. Let's reframe: 'Taking a break now ensures I don't crash before the exam.' Ready to take a break?`,options:[{text:`Yes, let's take a break.`,nextStepId:`burnout_action`}]},burnout_action:{id:`burnout_action`,text:`Your action step: Shut down your books, close all tabs, and do a 15-minute screen-free break. Take a shower, lay down, or listen to instrumental music. No phones, no studying. Can you do this right now?`,options:[{text:`Yes, I'm closing my books now.`,nextStepId:`finish_flow`},{text:`Let's do a box breathing exercise together to ease into the break.`,nextStepId:`run_breathing`}]},exercise_choice:{id:`exercise_choice`,text:`Great choice. Taking a physical pause is the fastest way to shut down high-intensity anxiety. Which exercise would you like to try?`,options:[{text:`Guided Box Breathing (4-4-4-4 technique)`,nextStepId:`run_breathing`},{text:`5-4-3-2-1 Sensory Grounding Wizard`,nextStepId:`run_grounding`}]},run_breathing:{id:`run_breathing`,text:`Opening the Guided Box Breathing tool for you. Focus on the expanding bubble and let your body settle.`,actionEffect:`show_breathing`},run_grounding:{id:`run_grounding`,text:`Opening the 5-4-3-2-1 Grounding Wizard. This will help bring your awareness back to the physical room.`,actionEffect:`show_grounding`},run_timer:{id:`run_timer`,text:`Opening the Pomodoro Study Timer. We will set a 25-minute focus session with a calming break.`,actionEffect:`show_timer`},finish_flow:{id:`finish_flow`,text:`You've taken a wonderful step for your mental wellness today. Remember that exams are a test of persistence, and being kind to yourself is key to staying persistent. You can check back here anytime you feel overwhelmed. Wish you all the best!`,options:[{text:`Back to starting options`,nextStepId:`start`}]}},yt=({onTriggerAction:e})=>{let[t,n]=(0,_.useState)([{id:`init`,sender:`bot`,text:vt.start.text}]),[r,i]=(0,_.useState)(vt.start),[a,o]=(0,_.useState)(!1),[s,c]=(0,_.useState)(``),l=(0,_.useRef)(null),u=(0,_.useRef)(null),d=(0,_.useRef)(0);(0,_.useEffect)(()=>{l.current?.scrollIntoView({behavior:`smooth`})},[t,a]),(0,_.useEffect)(()=>()=>{u.current&&window.clearTimeout(u.current)},[]);let f=(t,r)=>{let a=Qe(r,k.chatMessage);d.current+=1;let s=`user_${d.current}`;n(e=>[...e,{id:s,sender:`user`,text:a}]),o(!0);let c=vt[t]||vt.start;u.current=window.setTimeout(()=>{o(!1),d.current+=1;let t=`bot_${d.current}`;n(e=>[...e,{id:t,sender:`bot`,text:c.text}]),c.actionEffect&&e(c.actionEffect),i(c)},1e3)},p=(e,t)=>{f(t,e)};return(0,O.jsxs)(`div`,{className:`calmbot-layout glass-panel slide-in`,children:[(0,O.jsxs)(`header`,{className:`bot-header`,children:[(0,O.jsxs)(`div`,{className:`bot-header-title`,children:[(0,O.jsx)(xe,{className:`bot-header-icon`,size:22}),(0,O.jsxs)(`div`,{className:`bot-meta`,children:[(0,O.jsx)(`h3`,{children:`CalmBot Wellness Coach`}),(0,O.jsxs)(`span`,{className:`bot-status`,children:[(0,O.jsx)(`span`,{className:`status-dot animate-pulse`}),`Online • Empathetic CBT Support`]})]})]}),(0,O.jsxs)(`button`,{onClick:()=>{d.current+=1,n([{id:`reset_${d.current}`,sender:`bot`,text:vt.start.text}]),i(vt.start),o(!1),c(``)},className:`glass-btn reset-chat-btn`,"aria-label":`Restart conversation`,children:[(0,O.jsx)(Ee,{size:14}),`Reset Chat`]})]}),(0,O.jsxs)(`div`,{className:`chat-messages-container`,children:[t.map(e=>(0,O.jsx)(`div`,{className:`chat-bubble-wrapper ${e.sender}`,children:(0,O.jsx)(`div`,{className:`chat-bubble ${e.sender}`,children:(0,O.jsx)(`p`,{className:`bubble-text`,children:e.text})})},e.id)),a&&(0,O.jsx)(`div`,{className:`chat-bubble-wrapper bot`,children:(0,O.jsxs)(`div`,{className:`chat-bubble bot typing-bubble`,children:[(0,O.jsx)(`span`,{className:`typing-dot`}),(0,O.jsx)(`span`,{className:`typing-dot`}),(0,O.jsx)(`span`,{className:`typing-dot`})]})}),(0,O.jsx)(`div`,{ref:l})]}),(0,O.jsxs)(`footer`,{className:`chat-footer`,children:[!a&&r.options&&r.options.length>0&&(0,O.jsx)(`div`,{className:`chat-options-container`,role:`group`,"aria-label":`CalmBot response options`,children:r.options.map((e,t)=>(0,O.jsx)(`button`,{onClick:()=>p(e.text,e.nextStepId),className:`glass-btn chat-option-btn`,children:e.text},t))}),!a&&r.requiresTextInput&&(0,O.jsxs)(`form`,{onSubmit:e=>{if(e.preventDefault(),!s.trim())return;let t=Qe(s,k.chatMessage);c(``);let n=`start`;r.id===`mock_1`?n=`mock_2`:r.id===`backlog_1`?n=`backlog_2`:r.id===`backlog_2`&&(n=`backlog_action`),f(n,t)},className:`chat-input-form`,children:[(0,O.jsx)(`input`,{type:`text`,value:s,onChange:e=>c($e(e.target.value,k.chatMessage)),placeholder:r.textPlaceholder||`Type your response...`,className:`glass-input chat-text-input`,"aria-label":`CalmBot reflection response`,maxLength:k.chatMessage,required:!0}),(0,O.jsx)(`button`,{type:`submit`,className:`glass-btn glass-btn-primary chat-submit-btn`,"aria-label":`Send message`,children:(0,O.jsx)(Oe,{size:18})})]})]}),(0,O.jsx)(`style`,{children:`
        .calmbot-layout {
          display: flex;
          flex-direction: column;
          height: 600px;
      ...
      `})]})},bt={idle:{text:`Ready to breathe?`,duration:0,className:`phase-idle`},inhale:{text:`Breathe In Slowly...`,duration:4,className:`phase-inhale`},hold_in:{text:`Hold Your Breath...`,duration:4,className:`phase-hold-in`},exhale:{text:`Exhale Completely...`,duration:4,className:`phase-exhale`},hold_out:{text:`Hold Empty...`,duration:4,className:`phase-hold-out`}},xt=e=>{switch(e){case`inhale`:return`hold_in`;case`hold_in`:return`exhale`;case`exhale`:return`hold_out`;case`hold_out`:return`inhale`;default:return`idle`}},St=()=>{let[e,t]=(0,_.useState)(`idle`),[n,r]=(0,_.useState)(0),[i,a]=(0,_.useState)(0),[o,s]=(0,_.useState)(!1),c=(0,_.useRef)(null),l=(0,_.useRef)(null),u=(0,_.useRef)(null),d=(0,_.useRef)(null);(0,_.useEffect)(()=>{if(e===`idle`)return;let i=window.setTimeout(()=>{if(n>1){r(e=>e-1);return}let i=xt(e);t(i),r(bt[i].duration),e===`hold_out`&&a(e=>e+1)},1e3);return()=>window.clearTimeout(i)},[e,n]);let f=(0,_.useCallback)(()=>{if(l.current){try{l.current.stop()}catch{console.warn(`Audio source was already stopped.`)}l.current.disconnect(),l.current=null}if(u.current){try{u.current.stop()}catch{console.warn(`Audio oscillator was already stopped.`)}u.current.disconnect(),u.current=null}d.current&&=(d.current.disconnect(),null),c.current&&=(c.current.close(),null),s(!1)},[]);(0,_.useEffect)(()=>()=>{f()},[f]);let p=()=>{t(`inhale`),r(bt.inhale.duration),a(0)},m=()=>{t(`idle`),r(0)},h=()=>{try{let e=window.AudioContext||window.webkitAudioContext;if(!e)throw Error(`Web Audio API unavailable`);let t=new e;c.current=t;let n=2*t.sampleRate,r=t.createBuffer(1,n,t.sampleRate),i=r.getChannelData(0),a=0;for(let e=0;e<n;e++){let t=Xe()*2-1;i[e]=(a+.02*t)/1.02,a=i[e],i[e]*=3.5}let o=t.createBufferSource();o.buffer=r,o.loop=!0,l.current=o;let f=t.createGain();f.gain.setValueAtTime(.15,t.currentTime),d.current=f;let p=t.createOscillator();p.type=`sine`,p.frequency.setValueAtTime(.125,t.currentTime),u.current=p;let m=t.createGain();m.gain.setValueAtTime(.1,t.currentTime),p.connect(m),m.connect(f.gain),o.connect(f),f.connect(t.destination),o.start(0),p.start(0),s(!0)}catch{console.warn(`Synthesized audio could not be initialized.`)}};return(0,O.jsxs)(`div`,{className:`breathing-layout slide-in`,children:[(0,O.jsxs)(`div`,{className:`breathing-content glass-panel`,children:[(0,O.jsxs)(`div`,{className:`breathing-header`,children:[(0,O.jsx)(`h3`,{children:`Box Breathing Session`}),(0,O.jsx)(`p`,{children:`The 4-4-4-4 breathing technique is used by athletes and clinical psychologists to reset the nervous system and calm anxiety instantly.`})]}),(0,O.jsx)(`div`,{className:`orb-outer-container`,children:(0,O.jsx)(`div`,{className:`breathing-orb ${e}`,children:(0,O.jsxs)(`div`,{className:`orb-core`,children:[(0,O.jsx)(`span`,{className:`orb-text`,children:bt[e].text}),e!==`idle`&&(0,O.jsxs)(`span`,{className:`orb-seconds`,children:[n,`s`]})]})})}),(0,O.jsxs)(`div`,{className:`breathing-dashboard`,children:[(0,O.jsx)(`div`,{className:`session-stats`,children:(0,O.jsxs)(`span`,{className:`cycles-count`,children:[`Cycles Finished: `,(0,O.jsx)(`strong`,{children:i})]})}),(0,O.jsxs)(`div`,{className:`breathing-controls`,children:[e===`idle`?(0,O.jsxs)(`button`,{onClick:p,className:`glass-btn glass-btn-secondary start-session-btn`,children:[(0,O.jsx)(we,{size:16}),` Start Session`]}):(0,O.jsxs)(`button`,{onClick:m,className:`glass-btn stop-session-btn`,children:[(0,O.jsx)(De,{size:16}),` Stop Session`]}),(0,O.jsxs)(`button`,{onClick:()=>{o?f():h()},className:`glass-btn audio-toggle-btn ${o?`active`:``}`,title:`Toggle Ocean Soundscape`,children:[o?(0,O.jsx)(Le,{size:16,className:`active-audio-icon`}):(0,O.jsx)(Re,{size:16}),`Ocean Soundscape`]})]})]}),(0,O.jsxs)(`section`,{className:`breathing-info`,children:[(0,O.jsx)(ve,{size:16,className:`info-icon`}),(0,O.jsxs)(`div`,{className:`info-text-box`,children:[(0,O.jsx)(`h4`,{children:`How it works:`}),(0,O.jsxs)(`ol`,{children:[(0,O.jsx)(`li`,{children:`Inhale through your nose, expanding your belly for 4 seconds.`}),(0,O.jsx)(`li`,{children:`Hold that air in your lungs gently for 4 seconds.`}),(0,O.jsx)(`li`,{children:`Exhale slowly through your mouth, relaxing your shoulders for 4 seconds.`}),(0,O.jsx)(`li`,{children:`Hold your lungs empty for 4 seconds before the next breath.`})]})]})]})]}),(0,O.jsx)(`style`,{children:`
        .breathing-layout {
          max-width: 650px;
          margin: 0 auto;
        }
      ...
      `})]})},Ct=[{title:`Sight (See)`,icon:me,color:`#6366f1`,count:5,instruction:`Look around you. Slow your breathing down. Identify 5 separate items you can see. Describe them briefly below.`,prompt:`Name 5 things you see in the room...`},{title:`Touch (Feel)`,icon:Ne,color:`#0d9488`,count:4,instruction:`Focus on your physical body. Touch 4 different things around you and pay attention to their textures, weights, and temperatures.`,prompt:`Name 4 textures/objects you can feel right now...`},{title:`Sound (Hear)`,icon:Le,color:`#a855f7`,count:3,instruction:`Close your eyes for 10 seconds. Listen carefully to your surroundings. Identify 3 distinct sounds, no matter how faint.`,prompt:`Name 3 sounds you can hear...`},{title:`Smell (Sense)`,icon:ge,color:`#f59e0b`,count:2,instruction:`Inhale deeply. Notice the smells in the air around you. It could be books, a pencil eraser, food, soap, or coffee.`,prompt:`Name 2 scents you can smell...`},{title:`Taste (Awareness)`,icon:pe,color:`#ef4444`,count:1,instruction:`Take a sip of water or focus on the taste inside your mouth right now. What is 1 taste you can identify?`,prompt:`Name 1 taste you notice...`}],wt=()=>{let[e,t]=(0,_.useState)(-1),[n,r]=(0,_.useState)([,,,,,].fill(``)),i=()=>{e<Ct.length-1?t(e=>e+1):t(Ct.length)},a=()=>{t(e>0?e=>e-1:-1)},o=t=>{r(n=>{let r=[...n];return r[e]=$e(t,k.groundingEntry),r})},s=()=>{t(-1),r([,,,,,].fill(``))};if(e===-1)return(0,O.jsxs)(`div`,{className:`grounding-intro glass-panel slide-in`,children:[(0,O.jsxs)(`div`,{className:`intro-header`,children:[(0,O.jsx)(ke,{className:`intro-icon`,size:48}),(0,O.jsx)(`h3`,{children:`5-4-3-2-1 Sensory Grounding`})]}),(0,O.jsx)(`p`,{className:`intro-desc`,children:`When exam anxiety peaks, our brains get stuck in a loop of future-oriented panic ("What if I fail?"). Grounding pulls your awareness out of your head and anchors it back in the physical room. It takes less than 3 minutes.`}),(0,O.jsx)(`button`,{onClick:()=>t(0),className:`glass-btn glass-btn-primary start-grounding-btn`,children:`Begin Grounding Wizard`})]});if(e===Ct.length)return(0,O.jsxs)(`div`,{className:`grounding-complete glass-panel slide-in`,children:[(0,O.jsx)(ke,{className:`complete-icon`,size:48}),(0,O.jsx)(`h3`,{children:`Grounding Complete`}),(0,O.jsx)(`p`,{children:`Your nervous system has had a chance to regulate. Take a slow, deep breath. The panic is temporary, and you are safe in the present moment.`}),(0,O.jsxs)(`div`,{className:`summary-list`,children:[(0,O.jsx)(`h4`,{children:`Your Anchor Points:`}),(0,O.jsx)(`ul`,{children:Ct.map((e,t)=>(0,O.jsxs)(`li`,{children:[(0,O.jsxs)(`strong`,{children:[e.title,`:`]}),` `,Qe(n[t],k.groundingEntry)||`Reflected quietly`]},t))})]}),(0,O.jsxs)(`button`,{onClick:s,className:`glass-btn reset-grounding-btn`,children:[(0,O.jsx)(Ee,{size:14}),` Repeat Exercise`]})]});let c=Ct[e],l=c.icon;return(0,O.jsxs)(`div`,{className:`grounding-wizard glass-panel slide-in`,style:{"--step-color":c.color},children:[(0,O.jsxs)(`header`,{className:`wizard-header`,children:[(0,O.jsxs)(`span`,{className:`step-indicator`,children:[`Step `,e+1,` of 5`]}),(0,O.jsxs)(`div`,{className:`step-title-row`,children:[(0,O.jsx)(l,{className:`step-icon animate-bounce`,size:28}),(0,O.jsxs)(`h3`,{children:[`Identify `,c.count,` things you can `,c.title.split(` `)[1].replace(/[()]/g,``)]})]})]}),(0,O.jsxs)(`div`,{className:`wizard-body`,children:[(0,O.jsx)(`p`,{className:`step-instruction`,children:c.instruction}),(0,O.jsx)(`textarea`,{value:n[e],onChange:e=>o(e.target.value),placeholder:c.prompt,className:`glass-input step-textarea`,"aria-label":`${c.title} grounding reflection`,maxLength:k.groundingEntry,rows:3})]}),(0,O.jsxs)(`footer`,{className:`wizard-footer`,children:[(0,O.jsxs)(`button`,{onClick:a,className:`glass-btn back-btn`,children:[(0,O.jsx)(oe,{size:16}),` Back`]}),(0,O.jsxs)(`button`,{onClick:i,className:`glass-btn glass-btn-primary next-btn`,children:[e===Ct.length-1?`Finish`:`Next`,` `,(0,O.jsx)(se,{size:16})]})]}),(0,O.jsx)(`style`,{children:`
      ...
      `})]})},Tt=[`Stand up, stretch your arms overhead, and gently roll your shoulders back.`,`Follow the 20-20-20 rule: look at something 20 feet away for 20 seconds to rest your eyes.`,`Walk to the kitchen, grab a glass of water, and drink it slowly, noting its cool temperature.`,`Do a 1-minute box breathing cycle: inhale 4s, hold 4s, exhale 4s, hold 4s.`,`Step away from your desk completely. Do not check your phone or notifications during this break.`],Et=({onPomodoroComplete:e})=>{let[t,n]=(0,_.useState)(`focus`),[r,i]=(0,_.useState)(!1),[a,o]=(0,_.useState)(1500),[s,c]=(0,_.useState)(0),l=t===`focus`?1500:300,u=()=>{try{let e=window.AudioContext||window.webkitAudioContext;if(!e)return;let t=new e,n=t.createOscillator(),r=t.createGain();n.connect(r),r.connect(t.destination),n.type=`sine`,n.frequency.setValueAtTime(660,t.currentTime),r.gain.setValueAtTime(.15,t.currentTime),r.gain.exponentialRampToValueAtTime(.01,t.currentTime+.4),n.start(t.currentTime),n.stop(t.currentTime+.4)}catch{console.warn(`Timer audio cue could not be played.`)}};(0,_.useEffect)(()=>{if(!r)return;let a=window.setInterval(()=>{o(r=>r>1?r-1:(u(),t===`focus`?(e(),n(`break`),c(Math.floor(Xe()*Tt.length)),i(!1),300):(n(`focus`),i(!1),1500)))},1e3);return()=>window.clearInterval(a)},[r,t,e]);let d=()=>{i(!r)},f=()=>{i(!1),o(l)},p=e=>{i(!1),n(e),o(e===`focus`?1500:300)},m=e=>{let t=Math.floor(e/60),n=e%60;return`${t.toString().padStart(2,`0`)}:${n.toString().padStart(2,`0`)}`},h=(l-a)/l,g=2*Math.PI*90,v=g*(1-h);return(0,O.jsxs)(`div`,{className:`study-timer-layout slide-in`,children:[(0,O.jsxs)(`div`,{className:`study-timer-card glass-panel`,children:[(0,O.jsx)(`h3`,{className:`timer-title`,children:`Mindful Study Timer`}),(0,O.jsx)(`p`,{className:`timer-desc`,children:`Maintain high focus without running into mental exhaustion. Study in structured blocks.`}),(0,O.jsxs)(`div`,{className:`mode-toggle-container`,children:[(0,O.jsxs)(`button`,{onClick:()=>p(`focus`),className:`mode-btn ${t===`focus`?`active focus-mode`:``}`,children:[(0,O.jsx)(de,{size:16}),` Focus Session (25m)`]}),(0,O.jsxs)(`button`,{onClick:()=>p(`break`),className:`mode-btn ${t===`break`?`active break-mode`:``}`,children:[(0,O.jsx)(fe,{size:16}),` Calm Break (5m)`]})]}),(0,O.jsxs)(`div`,{className:`circular-timer-container`,children:[(0,O.jsxs)(`svg`,{className:`progress-ring-svg`,width:`220`,height:`220`,children:[(0,O.jsx)(`circle`,{className:`progress-ring-bg`,stroke:`var(--glass-border)`,strokeWidth:`8`,fill:`transparent`,r:90,cx:`110`,cy:`110`}),(0,O.jsx)(`circle`,{className:`progress-ring-bar ${t}`,strokeWidth:`8`,fill:`transparent`,r:90,cx:`110`,cy:`110`,strokeDasharray:g,strokeDashoffset:v,strokeLinecap:`round`})]}),(0,O.jsxs)(`div`,{className:`timer-digits-container`,children:[(0,O.jsx)(`span`,{className:`timer-digits`,children:m(a)}),(0,O.jsx)(`span`,{className:`timer-mode-label`,children:t===`focus`?`STUDYING`:`RESTING`})]})]}),(0,O.jsxs)(`div`,{className:`timer-controls`,children:[(0,O.jsxs)(`button`,{onClick:d,className:`glass-btn play-pause-btn ${r?`active`:``}`,children:[r?(0,O.jsx)(Ce,{size:18}):(0,O.jsx)(we,{size:18}),r?`Pause`:`Start`]}),(0,O.jsxs)(`button`,{onClick:f,className:`glass-btn reset-btn`,"aria-label":`Reset Timer`,children:[(0,O.jsx)(De,{size:16}),` Reset`]})]}),t===`break`&&(0,O.jsxs)(`div`,{className:`break-tips-box`,children:[(0,O.jsxs)(`div`,{className:`tips-box-header`,children:[(0,O.jsx)(_e,{size:16,className:`tip-icon`}),(0,O.jsx)(`span`,{children:`Recommended Mindful Break`})]}),(0,O.jsx)(`p`,{className:`tips-box-text`,children:Tt[s]})]})]}),(0,O.jsx)(`style`,{children:`
        .study-timer-layout {
          max-width: 500px;
          margin: 0 auto;
        }
      ...
      `})]})},j=({activeSubTool:e,setActiveSubTool:t,onPomodoroComplete:n})=>(0,O.jsxs)(`div`,{className:`wellness-tools-layout slide-in`,children:[(0,O.jsxs)(`header`,{className:`tools-subnav glass-panel`,children:[(0,O.jsxs)(`button`,{onClick:()=>t(`breathing`),className:`subnav-btn ${e===`breathing`?`active`:``}`,children:[(0,O.jsx)(ze,{size:16}),` Box Breathing`]}),(0,O.jsxs)(`button`,{onClick:()=>t(`grounding`),className:`subnav-btn ${e===`grounding`?`active`:``}`,children:[(0,O.jsx)(ae,{size:16}),` 5-4-3-2-1 Grounding`]}),(0,O.jsxs)(`button`,{onClick:()=>t(`timer`),className:`subnav-btn ${e===`timer`?`active`:``}`,children:[(0,O.jsx)(Me,{size:16}),` Focus Study Timer`]})]}),(0,O.jsxs)(`div`,{className:`tools-active-component`,children:[e===`breathing`&&(0,O.jsx)(St,{}),e===`grounding`&&(0,O.jsx)(wt,{}),e===`timer`&&(0,O.jsx)(Et,{onPomodoroComplete:n})]}),(0,O.jsx)(`style`,{children:`
      ...
      `})]}),Dt=class extends _.Component{state={hasError:!1};static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(e){console.error(`Recoverable application error: ${lt(e)}`)}handleReload=()=>{window.location.reload()};render(){return this.state.hasError?(0,O.jsxs)(`main`,{className:`app-error-boundary`,role:`alert`,"aria-live":`assertive`,children:[(0,O.jsx)(Ie,{size:36,"aria-hidden":`true`}),(0,O.jsx)(`h1`,{children:`We could not load this wellness view.`}),(0,O.jsx)(`p`,{children:`Your local entries stay on this device. Reload the app to return to a safe state.`}),(0,O.jsxs)(`button`,{type:`button`,className:`glass-btn glass-btn-primary`,onClick:this.handleReload,children:[(0,O.jsx)(Ee,{size:16,"aria-hidden":`true`}),`Reload ZenStudy`]})]}):this.props.children}},Ot=/^zenstudy_[a-z0-9_:-]{1,48}$/;function kt(e,t,n={}){if(!Ot.test(e))throw Error(`Unsafe localStorage key rejected`);let r=n.sanitize??(e=>e),[i,a]=(0,_.useState)(()=>{try{let n=window.localStorage.getItem(e);return n?r(JSON.parse(n)):t}catch(n){return console.warn(`Storage read skipped for ${e}: ${lt(n)}`),window.localStorage.removeItem(e),t}});return[i,t=>{try{let o=r(t instanceof Function?t(i):t);if(!ct(o,n.maxBytes))throw Error(`localStorage value exceeds safe size budget`);a(o),window.localStorage.setItem(e,JSON.stringify(o))}catch(t){console.warn(`Storage write skipped for ${e}: ${lt(t)}`)}}]}var At=(e,t)=>{let n={BASE_URL:`/Ai_challenges/`,DEV:!1,MODE:`production`,PROD:!0,SSR:!1}[e];return typeof n==`string`&&n.trim()?n.trim():t},jt={appName:At(`VITE_APP_NAME`,`ZenStudy`),appVersion:At(`VITE_APP_VERSION`,`1.0.0`),isDemoMode:!0};function Mt(){let[e,t]=(0,_.useState)(`dashboard`),[n,r]=(0,_.useState)(`breathing`),[i,a]=kt(`zenstudy_username`,`Student`,{sanitize:nt}),[o,s]=kt(`zenstudy_exam`,`JEE`,{sanitize:rt}),[c,l]=kt(`zenstudy_moodlogs`,[],{sanitize:st}),[u,d]=kt(`zenstudy_pomodoros`,0,{sanitize:at}),[f,p]=kt(`zenstudy_theme`,`dark`,{sanitize:it});return(0,_.useEffect)(()=>{document.documentElement.setAttribute(`data-theme`,f)},[f]),(0,_.useEffect)(()=>{document.title=`${jt.appName} — Student Mental Wellness Tracker`},[]),(0,O.jsx)(Dt,{children:(0,O.jsxs)(`div`,{className:`app-shell`,children:[(0,O.jsxs)(`div`,{className:`app-container`,children:[(0,O.jsx)(Ve,{activeTab:e,setActiveTab:t,theme:f,toggleTheme:()=>{p(e=>e===`dark`?`light`:`dark`)}}),(0,O.jsxs)(`main`,{className:`app-main-content`,id:`main-content`,children:[e===`dashboard`&&(0,O.jsx)(mt,{userName:i,setUserName:a,targetExam:o,setTargetExam:s,moodLogs:c,setActiveTab:t,pomodoroCount:u}),e===`tracker`&&(0,O.jsx)(ht,{moodLogs:c,onAddLog:e=>{let t=ot(e);t&&l(e=>st([t,...e]))},onDeleteLog:e=>{l(t=>t.filter(t=>t.id!==e))}}),e===`analytics`&&(0,O.jsx)(_t,{moodLogs:c}),e===`bot`&&(0,O.jsx)(yt,{onTriggerAction:e=>{e===`show_breathing`?(t(`tools`),r(`breathing`)):e===`show_grounding`?(t(`tools`),r(`grounding`)):e===`show_timer`&&(t(`tools`),r(`timer`))}}),e===`tools`&&(0,O.jsx)(j,{activeSubTool:n,setActiveSubTool:r,onPomodoroComplete:()=>{d(e=>e+1)}})]})]}),(0,O.jsx)(`style`,{children:`
        .app-shell {
          min-height: 100vh;
          width: 100%;
          display: flex;
      ...
      `})]})})}(0,v.createRoot)(document.getElementById(`root`)).render((0,O.jsx)(_.StrictMode,{children:(0,O.jsx)(Mt,{})}));